...
class CreateLabCalParameterOneTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lab_cal_parameter_one_transactions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lab_cal_parameter_one_transactions');
    }
}
