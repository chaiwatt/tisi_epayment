...
class CreateLabCalInstrumentTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lab_cal_instrument_transactions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lab_cal_instrument_transactions');
    }
}
