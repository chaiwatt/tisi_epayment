...
class AddLawCaseCompareBookLawCaseIdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('law_case_compare_book', function (Blueprint $table) {
            $table->dropForeign('law_case_compare_book_law_case_compare_id_foreign');
