...
class AddTisiBoardMeetingInSection5ApplicationIbcbBoardApprovesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('section5_application_ibcb_board_approves', function (Blueprint $table) {
