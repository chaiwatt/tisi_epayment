...
class ApplicationIBCBStatusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('section5_application_ibcb_status')->delete();

        \DB::table('section5_application_ibcb_status')->insert(array (
            array (
                'id' => 1,
