...
class IbcbsHistory extends Model
{
    use Sortable;
    /**
     ...
     * @var string
     */
    protected $table = 'section5_ibcbs_history';
    ...
    */
    ...
    /* บันทึกข้อมูล */
    static function Add($ibcb_id, $data_field, $data_old, $data_new, $remark=null, $created_by=null){

        if(is_null($created_by)){//ถ้าไม่มีส่งเข้ามา
            $created_by = auth()->user()->getKey();
        }

        $history = new IbcbsHistory;
        $history->ibcb_id     = $ibcb_id;
    ...
    public function getDataFieldNameAttribute()
    {
        ...
        $columns = [
            "name"                => 'ชื่อ-นามสกุล',
            "initial"             => 'ชื่อย่อหน่วยรับรอง',
            "taxid"               => 'เลขนิติบุคคลผู้เสียภาษี',
            "ibcb_name"           => 'ชื่อหน่วยงาน',
            "ibcb_address"        => 'ที่อยู่',
            "ibcb_building"       => 'หมู่บ้าน/อาคาร',
            "ibcb_soi"            => 'ตรอก/ซอย',
            "ibcb_moo"            => 'หมู่ที่',
            "ibcb_phone"          => 'โทรศัพท์',
            "ibcb_fax"            => 'โทรสาร',
            "ibcb_subdistrict_id" => 'ตำบล/แขวง',
            "ibcb_district_id"    => 'อำเภอ/เขต',
            "ibcb_province_id"    => 'จังหวัด',
            "ibcb_zipcode"        => 'รหัสไปรษณีย์',
