...
class LawRewardGroup extends Model
{
    use Sortable;
    /**
     ...
     * @var string
     */
    protected $table = 'law_basic_reward_group';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['title', 'state', 'condition_formscase', 'ordering', 'created_by', 'updated_by'];

    /*
      Sorting
    */
    public $sortable = ['title', 'state', 'condition_formscase', 'ordering','created_by', 'updated_by'];
