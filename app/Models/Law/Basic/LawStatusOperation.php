...
class LawStatusOperation extends Model
{
    use Sortable;
    /**
     ...
     * @var string
     */
    protected $table = 'law_basic_status_operate';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['title', 'law_bs_category_operate_id', 'state', 'created_by', 'updated_by'];

    /*
      Sorting
    */
    public $sortable = ['title', 'law_bs_category_operate_id', 'state', 'created_by', 'updated_by'];
    ...
    */
    ...
    public function law_category_operate(){
        return $this->belongsTo(LawCategoryOperation::class, 'law_bs_category_operate_id');
    }

    public function getCategoryOperationNameAttribute() {
        return @$this->law_category_operate->title;
    }
