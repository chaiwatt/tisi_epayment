...
class LawListenMinistryResults extends Model
{
      /**
     ...
     * @var string
     */
    protected $table = 'law_listen_ministry_results';
    ...
    */
    ...
    public function AttachFileGazette()
    {
        return $this->hasOne(AttachFileLaw::class,'ref_id','id')->where('ref_table',$this->table)->where('section','file_listen_ministry_result');
    }
}
