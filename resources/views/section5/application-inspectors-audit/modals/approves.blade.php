                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group required">
                                {!! Form::label('audit_approve', 'สถานะ'.' :', ['class' => 'col-md-3 control-label']) !!}
                                <div class="col-md-8">
                                    {!! Form::select('audit_approve',  App\Models\Section5\ApplicationInspectorStatus::whereIn('id', [7,8] )->pluck('title', 'id')->all(), null, ['class' => 'form-control', 'placeholder' => '-เลือกสถานะ-', 'required' => true]) !!}
                                </div>
                            </div>

                            <div class="form-group">
                                {!! Form::label('audit_approve_description', 'รายละเอียด'.' :', ['class' => 'col-md-3 control-label']) !!}
                                <div class="col-md-8">
                                    {!! Form::textarea('audit_approve_description', null ,  ['class' => 'form-control', 'rows' => 4]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
