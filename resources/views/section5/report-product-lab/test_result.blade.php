                                ...
                                <table class="table table-striped table-bordered" id="myTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="14%" class="text-center text-middle">ไฟล์ผลทดสอบ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($sample->sample_details as $key => $sample_detail)
                                            @php
                                                $result_file = json_decode($sample_detail->result_file);
                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-top">
                                                    @if (!is_null($result_file))
                                                        <a href="{{ $config->url_elicense_trader.'/media/com_rform/productlab/'.$sample->id.'/'.$result_file->realfile }}" target="_blank">
