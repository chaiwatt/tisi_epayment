    ...
    <div class="col-lg-12 col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ประวัติการตรวจสอบคำขอ # {!! $applicationlab->application_no !!}
                    ...
                    <div class="table-responsive">
                        <table class="table-bordered table table-hover primary-table" id="table-history">
                            ...
                            <tbody data-repeater-list="repeater-history" id="box_list_history">
                                ...
                                @php
                                    $accepts_history = $applicationlab->app_accept()->where('application_status', '>', 0)->get();
                                @endphp
                                ...
                                @foreach($accepts_history as $key=> $item)
                                    <tr>
                                        ...
                                        <td>
                                            {{ HP::DateTimeFullThai($item->created_at) }}
                                        </td>
                                        <td>
                                            {{ $item->AppStatus }}
                                        </td>
