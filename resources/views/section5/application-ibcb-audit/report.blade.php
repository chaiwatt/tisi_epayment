...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">บันทึกสรุปรายงานผลการตรวจประเมิน (IB/CB) #{{ $applicationibcb->application_no }}</h3>
                    ...
                    {!! Form::model($applicationibcb, [
                        'method' => 'PATCH',
                        'url' => ['/section5/application-ibcb-audit/report-save', $applicationibcb->id],
