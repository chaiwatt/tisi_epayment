    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                            ...
                            <table class="table table-bordered table-striped m-b-0" id="myTable-Mannouncement">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%" class="text-center">วันประชุมคณะอนุฯ</th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm waves-effect waves-light" id="btn_save_announcement">สร้างไฟล์ประกาศ</button>
            </div>
        </div>
    </div>
</div>
