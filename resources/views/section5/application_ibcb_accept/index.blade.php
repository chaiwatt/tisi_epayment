        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left">ระบบรับคำขอแต่งตั้งเป็นผู้ตรวจสอบการทำผลิตภัณฑ์อุตสาหกรรม (IB/CB)</h3>

                    <div class="pull-right">

                        @can('assign_work-'.str_slug('application-ibcb-accept'))
                    ...
                    <p class="text-muted m-b-30 font-13"><em>รับคำขอแต่งตั้งเป็นผู้ตรวจสอบการทำผลิตภัณฑ์อุตสาหกรรม (IB/CB) - พิจารณาคำขอ</em></p>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        {!! Form::text('filter_search', null, ['class' => 'form-control', 'id' => 'filter_search', 'placeholder'=>'ค้นหาจาก เลขที่คำขอ/ผู้ยื่นคำขอ/เลขผู้เสียภาษี/ผู้รับมอบหมาย/สาขา/รายสาขา/มอก.']); !!}
                                    </div><!-- /form-group -->
                                </div><!-- /.col-lg-4 -->
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        {!! Form::select('filter_status', App\Models\Section5\ApplicationIbcbStatus::pluck('title', 'id')->all(), null, ['class' => 'form-control', 'id' => 'filter_status', 'placeholder'=>'-เลือกสถานะ-']); !!}
                                    </div>
                                </div><!-- /.col-lg-5 -->
                            </div><!-- /.row -->
                    ...
                    @include ('section5.application_ibcb_accept.modals')
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/section5/application_ibcb_accept/data_list') !!}',
                    data: function (d) {
            ...
            $('#btn_save_modal').click(function (e) {
                ...
                if( checkNone(assign_by)  ){
                    ...
                    $.ajax({
                        type:"POST",
                        url:  "{{ url('/section5/application_ibcb_accept/assing_data_update') }}",
                        data:{
                            _token: "{{ csrf_token() }}",
                            id: id,
                            assign_by: assign_by,
