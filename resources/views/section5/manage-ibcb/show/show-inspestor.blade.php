    ...
    <div id="accordion-ins">
        ...
        @foreach ($scope_list as $group)
            @php
                ...
                $scope_ids  = App\Models\Section5\IbcbsScope::where('branch_group_id', $group->branch_group_id)->pluck('id');
                $branch_ids = App\Models\Section5\IbcbsScopeDetail::whereIn('ibcb_scope_id', $scope_ids)->groupBy('branch_id')->pluck('branch_id');
                    ...
                    <div class="card-body">
                        <ul>
                            ...
                            @if( count($inspestor_list) == 0 )
                                <li class="text-danger"><em>ไม่พบข้อมูลผู้ตรวจ/ผู้ประเมิน ในผลิตภัณฑ์ </em></li>
                            @endif
                        </ul>
                    </div>
                </div>
