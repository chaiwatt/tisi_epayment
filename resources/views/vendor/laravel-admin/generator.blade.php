            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('/crud-generator') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" required name="crud_name" value="{{old('crud_name')}}"
                                       class="form-control" id="crud_name" placeholder="Posts">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{old('controller_namespace')}}" name="controller_namespace"
                                       class="form-control" id="controller_namespace" placeholder="Admin">
                        ...
                        {{--<div class="form-group row">--}}
                        {{--<label for="roles"  class="col-md-4 col-form-label text-right">Roles:</label>--}}
                        {{--<div class="col-md-6">--}}
                        {{--<select class="selectpicker form-control"  name="roles" id="roles" required multiple>--}}
                        {{--@foreach($roles as $role)--}}
                        {{--<option @if($role->name == 'user') selected @endif value="{{$role->id}}">{{$role->name}}</option>--}}
                        {{--@endforeach--}}
                        {{--</select>--}}

                        {{--<input type="text" value="{{old('roles')}}" name="roles" required class="form-control" id="roles" placeholder="Roles">--}}
                        {{--@if ($errors->has('roles'))--}}
                        {{--<span class="help-block error">--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{old('route_group')}}" name="route_group"
                                       class="form-control" id="route_group" placeholder="admin">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{old('view_path')}}" name="view_path" class="form-control"
                                       id="view_path" placeholder="admin">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn-add', function (e) {
                ...
                newEntry.find('select').prev().remove();
                newEntry.find('select').prop('style', '');
