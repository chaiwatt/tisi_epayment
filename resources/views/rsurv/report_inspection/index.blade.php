            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="col-sm-12" style="border-bottom: solid 2px royalblue;">
                        <h3 class="pull-left">รายงานแจ้งผลการทดสอบผลิตภัณฑ์</h3>
                    </div>

                    <div class="panel-group" id="accordion">
                        <div class="panel card-collaps">
                            <div class="clearfix"></div>
                            {!! Form::model($filter, ['url' => '/rsurv/report_inspection', 'method' => 'get', 'id' => 'myFilter']) !!}
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12 row">
                                      <div class="col-md-8">
                                        {!! Form::label('filter_start_date', 'วันที่ทดสอบ:', ['class' => 'col-md-2 control-label']) !!}
                                      ...
                                      <div class="col-md-4">
                                          {!! Form::label('filter_inspector', 'หน่วยทดสอบ:', ['class' => 'col-md-3 control-label label-filter']) !!}
                                          <div class="col-md-9">
                                              {!! Form::select('filter_inspector', HP::InspectorList(['2'])+['NULL'=>'อื่น ๆ'], null, ['class' => 'form-control', 'placeholder'=>'-เลือกหน่วยทดสอบ-']); !!}
                                          </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-8 row">
                                          ...
                                          <div class="pull-right">
                                            ...
                                            <button type="button" onclick="$('#myFilter').prop('action', '{{ url('rsurv/report_inspection/export_excel') }}'); this.form.submit();" class="btn btn-success waves-effect waves-light" formtarget="_blank">
                                              <i class="mdi mdi-file-excel"></i> Export Excel
                                            </button>

                                            <button type="submit" onclick="$('#myFilter').prop('action', '{{ url('rsurv/report_inspection') }}'); this.form.submit();" class="btn btn-primary waves-effect waves-light ">
                        ...
                        <div class="wrapper">
                            <label class="wrapper-label">
                                รายงานการแจ้งผลการทดสอบผลิตภัณฑ์
                            </label>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table color-bordered-table primary-bordered-table table-bordered table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 8%;">วันที่ทดสอบ</th>
                                    <th style="width: 10%;">หน่วยทดสอบ</th>
                                    <th style="width: 7%;">หมายเหตุ</th>
                                    <th style="width: 9%;">ไฟล์แนบ</th>
