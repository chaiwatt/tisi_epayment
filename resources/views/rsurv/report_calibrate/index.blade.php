            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="col-sm-12" style="border-bottom: solid 2px royalblue;">
                        <h3 class="pull-left">รายงานแจ้งผลการสอบเทียบเครื่องมือวัด</h3>
                    </div>

                    <div class="panel-group" id="accordion">
                        <div class="panel card-collaps">
                            <div class="clearfix"></div>
                            {!! Form::model($filter, ['url' => '/rsurv/report_calibrate', 'method' => 'get', 'id' => 'myFilter']) !!}
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12 row">
                                      <div class="col-md-8">
                                        {!! Form::label('filter_start_date', 'วันที่สอบเทียบ:', ['class' => 'col-md-2 control-label']) !!}
                                      ...
                                      <div class="col-md-4">
                                          {!! Form::label('filter_tool', 'ชื่อเครื่องมือ:', ['class' => 'col-md-4 control-label label-filter']) !!}
                                          <div class="col-md-8">
                                            {!! Form::text('filter_tool', null, ['class' => 'form-control', 'placeholder'=>'ค้นจากชื่อเครื่องมือ']); !!}
                                          </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-8 row">
                                          ...
                                          <div class="pull-right">
                                            ...
                                            <button type="button" onclick="$('#myFilter').prop('action', '{{ url('rsurv/report_calibrate/export_excel') }}'); this.form.submit();" class="btn btn-success waves-effect waves-light" formtarget="_blank">
                                              <i class="mdi mdi-file-excel"></i> Export Excel
                                            </button>

                                            <button type="submit" onclick="$('#myFilter').prop('action', '{{ url('rsurv/report_calibrate') }}'); this.form.submit();" class="btn btn-primary waves-effect waves-light ">
                        ...
                        <div class="wrapper">
                            <label class="wrapper-label">
                                รายงานการแจ้งผลการสอบเทียบเครื่องมือวัด
                            </label>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table color-bordered-table primary-bordered-table table-bordered table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 17%;">มอก.</th>
                                    <th style="width: 8%;">วันที่แจ้ง</th>
                                    <th style="width: 8%;">ใบอนุญาต</th>
                                    <th style="width: 9%;">ชื่อเครื่องมือ</th>
                                    <th style="width: 8%;">รายการที่ใช้วัด</th>
                                    <th style="width: 8%;">วันที่สอบเทียบ</th>
                                    <th style="width: 9%;">ผลการสอบเทียบ</th>
                                ...
                                <tbody>
                                  @foreach ($items as $key => $item)
                                    ...
                                    <tr>
                                      ...
                                      <td class="text-top">{{ implode(' ', $item->detail_list->pluck('tool', 'id')->toArray()) }}</td>
                                      <td class="text-top">
                                      ...
                                      <td class="text-top">
                                        @foreach ($item->detail_list as $detail)
                                            <div>-{{ HP::DateThai($detail->exam_date) }}</div>
                                        @endforeach
                                      </td>
                                      ...
                                      <td class="text-top">
                                        ...
                                        @foreach ($item->detail_list as $detail)
                                          @foreach (json_decode($detail->attach_result) as $attach)
                                            @if($attach->file_name!='' && HP::checkFileStorage($attach_path.$attach->file_name))
                                              <a href="{{ HP::getFileStorage($attach_path.$attach->file_name) }}" target="_blank" class="btn btn-info btn-sm" style="margin-bottom:2px;">
