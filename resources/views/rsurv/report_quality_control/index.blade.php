            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="col-sm-12" style="border-bottom: solid 2px royalblue;">
                        <h3 class="pull-left">รายงานแจ้งผลการประเมิน QC</h3>
                    </div>

                    <div class="panel-group" id="accordion">
                        <div class="panel card-collaps">
                            <div class="clearfix"></div>
                            {!! Form::model($filter, ['url' => '/rsurv/report_quality_control', 'method' => 'get', 'id' => 'myFilter']) !!}
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12 row">
                                      ...
                                      <div class="col-md-4">
                                          {!! Form::label('filter_license', 'ใบอนุญาต:', ['class' => 'col-md-4 control-label label-filter']) !!}
                                          <div class="col-md-8">
                                    ...
                                    <div class="col-md-12 row">
                                      <div class="col-md-8">
                                        {!! Form::label('filter_start_date', 'วันที่ตรวจ:', ['class' => 'col-md-2 control-label']) !!}
                                      ...
                                      <div class="col-md-4">
                                          {!! Form::label('filter_factory', 'ชื่อโรงงาน:', ['class' => 'col-md-4 control-label label-filter']) !!}
                                          <div class="col-md-8">
                                            {!! Form::text('filter_factory', null, ['class' => 'form-control', 'placeholder'=>'ค้นจากชื่อโรงงาน']); !!}
                                          </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::label('filter_inspector', 'ผู้ตรวจประเมิน:', ['class' => 'col-md-3 control-label label-filter']) !!}
                                            <div class="col-md-9">
                                                {!! Form::select('filter_inspector', HP::InspectorList(['1'])+['NULL'=>'อื่น ๆ'], null, ['class' => 'form-control', 'placeholder'=>'-เลือกผู้ตรวจประเมิน-']); !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="pull-right">
                                            ...
                                            <button type="button" onclick="$('#myFilter').prop('action', '{{ url('rsurv/report_quality_control/export_excel') }}'); this.form.submit();" class="btn btn-success waves-effect waves-light" formtarget="_blank">
                                              <i class="mdi mdi-file-excel"></i> Export Excel
                                            </button>

                                            <button type="submit" onclick="$('#myFilter').prop('action', '{{ url('rsurv/report_quality_control') }}'); this.form.submit();" class="btn btn-primary waves-effect waves-light ">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table color-bordered-table primary-bordered-table table-bordered table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 8%;">ชื่อโรงงาน</th>
                                    <th style="width: 7%;">วันที่ตรวจ</th>
                                    <th style="width: 7%;">ผู้ตรวจประเมิน</th>
                                    <th style="width: 7%;">รายละเอียดการตรวจ</th>
                                    <th style="width: 15%;">ผลการตรวจ</th>
                                ...
                                <tbody>
                                  @foreach ($items as $key => $item)
                                    ...
                                    <tr>
                                      ...
                                      <td class="text-top">{{ $item->factory_name }}</td>
                                      <td class="text-top">{{ HP::DateThai($item->check_date) }}</td>
                                      <td class="text-top">
                                        @if(!is_null($item->inspector))
                                          {{ $item->inspector_u->title }}
                                        @else
                                          {{ $item->inspector_other }}
                                        @endif
                                      </td>
