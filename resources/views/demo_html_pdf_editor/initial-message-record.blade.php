    ...
    <div class="wrapper">
        ...
        <form id="labMessageForm" method="POST" action="{{ route('save.create_lab_message_record') }}">
            ...
            <div class="section">
                ...
                <div class="content">
                    <div class="info">
                        ...
                        <div class="content" style="margin-left: -20px">
                            <div style="margin-top: 10px">
                                @include('demo_html_pdf_editor.editor', ['id' => '5'])
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section">
                ...
                <div class="content">
                    <div style="margin-top: 10px">
                        @include('demo_html_pdf_editor.editor', ['id' => '6'])
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="content">
                    <div style="margin-top: 10px">
                        @include('demo_html_pdf_editor.editor', ['id' => '7'])
                    </div>
                </div>
            </div>
...
$('#btn_submit').on('click', function() {
   ...
   console.log('ok')
    ...
    $.ajax({
        type: "POST",
        url: "{{url('/certify/cb-report-store')}}",
        datatype: "script",
        data: formData,
        contentType: false,
        cache: false,
