...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Commentstandarddrafs</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('comment-standard-drafts'))
                      ...
                      @can('add-'.str_slug('comment-standard-drafts'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/tis/comment_standard_drafts/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('comment-standard-drafts'))
                    ...
                    {!! Form::model($filter, ['url' => 'comment_standard_drafts', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/tis/comment_standard_drafts/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/tis/comment_standard_drafts/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>Comment</th><th>Name</th><th>Tel</th><th>Email</th><th>Department Id</th>
                            ...
                            <tbody>
                            @foreach($comment_standard_drafts as $item)
                                <tr>
                                    {{-- <td>{{ $loop->iteration or $item->id }}</td> --}}
                                    <td class="text-top">{{ $comment_standard_drafts->perPage()*($comment_standard_drafts->currentPage()-1)+$loop->iteration }}</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('comment-standard-drafts'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/tis/comment_standard_drafts/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('comment-standard-drafts'))
                                            <a href="{{ url('/tis/comment_standard_drafts/' . $item->id) }}"
                                               title="View CommentStandardDraf" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('comment-standard-drafts'))
                                            <a href="{{ url('/tis/comment_standard_drafts/' . $item->id . '/edit') }}"
                                        ...
                                        @can('delete-'.str_slug('comment-standard-drafts'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['comment_standard_draft', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete CommentStandardDraft',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $comment_standard_drafts->appends(['search' => Request::get('search'),
