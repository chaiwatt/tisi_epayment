...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "กิจกรรม:"; }
    td:nth-of-type(4):before { content: "สาขาและขอบข่าย:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">กิจกรรมของ GHG</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('ghg_activity'))
                      ...
                      @can('add-'.str_slug('ghg_activity'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/ghg_activity/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('ghg_activity'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/ghg_activity', 'method' => 'get', 'id' => 'myFilter']) !!}
                      ...
                      <div class="col-md-6">
                          {!! Form::label('filter_ghg', 'สาขาและขอบข่าย:', ['class' => 'col-md-4 control-label label-filter']) !!}
                          <div class="col-md-8">
                            {!! Form::select('filter_ghg', App\Models\Bcertify\Ghg::pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder'=>'-เลือกสาขาและขอบข่าย-', 'onchange'=>'this.form.submit()']); !!}
                          </div>
                      </div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/ghg_activity/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/ghg_activity/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'กิจกรรม')</th>
                                <th>@sortablelink('ghg_id', 'สาขาและขอบข่าย')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('ghg_activity'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/ghg_activity/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('ghg_activity'))
                                            <a href="{{ url('/bcertify/ghg_activity/' . $item->id) }}"
                                               title="View ghg_activity" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('ghg_activity'))
                                            <a href="{{ url('/bcertify/ghg_activity/' . $item->id . '/edit') }}"
                                               title="Edit ghg_activity" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('ghg_activity'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/ghg_activity', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete ghg_activity',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $ghg_activity->appends(['search' => Request::get('search'),
