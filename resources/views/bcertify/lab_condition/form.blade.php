...
<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
    {!! Form::label('title', 'ชื่อสถานภาพ (TH)', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('title_en') ? 'has-error' : ''}}">
    {!! Form::label('title_en', 'ชื่อสถานภาพ (EN)', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('lab_condition'))
            <a class="btn btn-default" href="{{url('/bcertify/lab_condition')}}">
