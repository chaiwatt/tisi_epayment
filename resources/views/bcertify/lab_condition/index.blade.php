...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "สถานภาพ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สถานภาพห้องปฏิบัติการ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('lab_condition'))
                      ...
                      @can('add-'.str_slug('lab_condition'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/lab_condition/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('lab_condition'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/lab_condition', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/lab_condition/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/lab_condition/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อสถานภาพ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('lab_condition'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/lab_condition/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('lab_condition'))
                                            <a href="{{ url('/bcertify/lab_condition/' . $item->id) }}"
                                               title="View lab_condition" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('lab_condition'))
                                            <a href="{{ url('/bcertify/lab_condition/' . $item->id . '/edit') }}"
                                               title="Edit lab_condition" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('lab_condition'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/lab_condition', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete lab_condition',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $lab_condition->appends(['search' => Request::get('search'),
