...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(5):before { content: "มอก.:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สาขาการรับรอง (CB)</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('certification_branch'))
                      ...
                      @can('add-'.str_slug('certification_branch'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/certification_branch/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('certification_branch'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/certification_branch', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/certification_branch/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/certification_branch/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'สาขาการรับรอง')</th>
                                <th>@sortablelink('initial', 'ชื่อย่อ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('certification_branch'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/certification_branch/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('certification_branch'))
                                            <a href="{{ url('/bcertify/certification_branch/' . $item->id) }}"
                                               title="View certification_branch" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('certification_branch'))
                                            <a href="{{ url('/bcertify/certification_branch/' . $item->id . '/edit') }}"
                                               title="Edit certification_branch" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('certification_branch'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/certification_branch', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete certification_branch',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $certification_branch->appends(['search' => Request::get('search'),
