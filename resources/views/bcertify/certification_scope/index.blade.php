...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "สาขาการรับรอง:"; }
    td:nth-of-type(4):before { content: "มอก.:"; }
    td:nth-of-type(5):before { content: "ชื่อย่อ:"; }
    td:nth-of-type(6):before { content: "ขอบข่ายการรับรอง:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ขอบข่ายการรับรอง</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('certification_scope'))
                      ...
                      @can('add-'.str_slug('certification_scope'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/certification_scope/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('certification_scope'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/certification_scope', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/certification_scope/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/certification_scope/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('certification_branch_id', 'สาขาการรับรอง')</th>
                                <th>มอก.</th>
                                <th>ชื่อย่อ</th>
                                <th>@sortablelink('scope_type', 'ขอบข่ายการรับรอง')</th>
                            ...
                            <tbody>
                            @foreach($certification_scope as $item)
                                <tr>
                                    <td>{{ $loop->iteration or $item->id }}</td>
                                    <td><input type="checkbox" name="cb[]" class="cb" value="{{ $item->id }}"></td>
                                    <td>{{ $item->certification_branch->title }}</td>
                                    <td>{{ $item->certification_branch->formula->title }}</td>
                                    <td>{{ $item->certification_branch->initial }}</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('certification_scope'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/certification_scope/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('certification_scope'))
                                            <a href="{{ url('/bcertify/certification_scope/' . $item->id) }}"
                                               title="View certification_scope" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('certification_scope'))
                                            <a href="{{ url('/bcertify/certification_scope/' . $item->id . '/edit') }}"
                                               title="Edit certification_scope" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('certification_scope'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/certification_scope', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete certification_scope',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $certification_scope->appends(['search' => Request::get('search'),
