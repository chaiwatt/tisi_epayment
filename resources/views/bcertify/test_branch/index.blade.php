...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "ชื่อสาขา:"; }
    td:nth-of-type(4):before { content: "มาตรฐาน มอก.:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สาขาการทดสอบ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('test_branch'))
                      ...
                      @can('add-'.str_slug('test_branch'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/test_branch/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('test_branch'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/test_branch', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/test_branch/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/test_branch/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อสาขาการทดสอบ')</th>
                                <th>@sortablelink('formula_id', 'มาตรฐาน มอก.')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('test_branch'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/test_branch/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('test_branch'))
                                            <a href="{{ url('/bcertify/test_branch/' . $item->id) }}"
                                               title="View test_branch" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('test_branch'))
                                            <a href="{{ url('/bcertify/test_branch/' . $item->id . '/edit') }}"
                                               title="Edit test_branch" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('test_branch'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/test_branch', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete test_branch',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $test_branch->appends(['search' => Request::get('search'),
