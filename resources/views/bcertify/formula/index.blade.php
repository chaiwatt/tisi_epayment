...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(4):before { content: "ประเภทผู้ยื่นคำขอ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">มาตรฐาน</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('formula'))
                      ...
                      @can('add-'.str_slug('formula'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/formula/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('formula'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/formula', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/formula/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/formula/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'มาตรฐาน')</th>
                                <th>@sortablelink('applicant_type', 'ประเภทผู้ยื่นคำขอ')</th>
                            ...
                            @foreach($formula as $item)
                                <tr>
                                    ...
                                    <td>{{ HP::CertifyApplicantTypes()[$item->applicant_type] }}</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('formula'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/formula/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('formula'))
                                            <a href="{{ url('/bcertify/formula/' . $item->id) }}"
                                               title="View formula" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('formula'))
                                            <a href="{{ url('/bcertify/formula/' . $item->id . '/edit') }}"
                                               title="Edit formula" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $formula->appends(['search' => Request::get('search'),
