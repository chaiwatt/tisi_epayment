...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สาขาการสอบเทียบ</h3>
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อสาขาการสอบเทียบ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('calibration_branch'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/calibration_branch/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('calibration_branch'))
                                            <a href="{{ url('/bcertify/calibration_branch/' . $item->id) }}"
                                        ...
                                        @can('edit-'.str_slug('calibration_branch'))
                                            <a href="{{ url('/bcertify/calibration_branch/' . $item->id . '/edit') }}"
                                        ...
                                        @can('delete-'.str_slug('calibration_branch'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/calibration_branch', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $calibration_branch->appends(['search' => Request::get('search'),
