...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">GHG</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('ghg'))
                      ...
                      @can('add-'.str_slug('ghg'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/ghg/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('ghg'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/ghg', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/ghg/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/ghg/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('formula_id', 'เลขมาตรฐาน')</th>
																<th>@sortablelink('title', 'สาขาและขอบข่าย')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('view-'.str_slug('ghg'))
                                            <a href="{{ url('/bcertify/ghg/' . $item->id) }}"
                                               title="View ghg" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('ghg'))
                                            <a href="{{ url('/bcertify/ghg/' . $item->id . '/edit') }}"
                                               title="Edit ghg" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $ghg->appends(['search' => Request::get('search'),
