...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">แก้ไขขอบข่าย Lab (ทดสอบ) #{{ $testBranch->title }}</h3>
                    ...
                    {!! Form::model($testBranch, [
                        'method' => 'PATCH',
                        'url' => ['/bcertify/setting_scope_lab_test', $testBranch->id],
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('title', $testBranch->title, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group {{ $errors->has('position2') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('title_en', $testBranch->en, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
