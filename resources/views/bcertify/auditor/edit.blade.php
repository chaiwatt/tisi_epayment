        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left">แก้ไขข้อมูลผู้ตรวจประเมิน</h3>
                    <div class="clearfix"></div>
                    <form  action="{{ route('bcertify.auditor.store.update') }}"
                          method="POST" enctype="multipart/form-data" class="form-horizontal" id="commentForm" >
                        <!-- CSRF Token -->
                        ...
                        <div id="rootwizard">
                            ...
                            <div class="tab-content">
                                <input type="hidden" name="token" value="{{$auditor->token}}">
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    <label class="col-md-3 control-label label-filter text-right" for="title">คำนำหน้า: </label>
                                                    <div class="col-md-9">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center" id="title" name="title" >
                                                            <option selected >{{$auditor->title_th}}</option>
                                                ...
                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="th_fname">ชื่อ (TH): </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control " id="th_fname" name="th_fname" required value="{{$auditor->fname_th}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="th_lname">นามสกุล (TH): </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control " id="th_lname" name="th_lname" required value="{{$auditor->lname_th}}">
                                                    </div>
                                                </div>

                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="title_en">คำนำหน้า: </label>
                                                    <input type="hidden" name="title_en" id="title_en" value="{{$auditor->title_en}}">
                                                    <div class="col-md-9 m-t-10">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center" id="title_en_js" name="title_en_js"  disabled>
                                                            <option selected >{{$auditor->title_en}}</option>
                                                ...
                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="en_fname">ชื่อ (EN): </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="en_fname" name="en_fname" style="text-transform:uppercase" required value="{{$auditor->fname_en}}">
                                                    </div>
                                                </div>

                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="en_lname">นามสกุล (EN): </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control " id="en_lname" name="en_lname" style="text-transform:uppercase" required value="{{$auditor->lname_en}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="address">ที่อยู่: </label>
                                                    <div class="col-md-9">
                                                        <textarea class="form-control" name="address" id="address" cols="30" rows="3" required>{{$auditor->address}}</textarea>
                                                    </div>
                                                </div>

                                                <div class="col-md-12 m-t-10">
                                                    @php
                                                        $provinces = \App\Models\Basic\Province::orderBy('PROVINCE_NAME','asc')->get();
                                                        $old_provinces = \App\Models\Basic\Province::where('PROVINCE_ID',$auditor->province_id)->first();
                                                        $old_amphur = \App\Models\Basic\Amphur::where('AMPHUR_ID',$auditor->amphur_id)->first();
                                                        $old_district = \App\Models\Basic\District::where('DISTRICT_ID',$auditor->district_id)->first();
                                                    @endphp
                                                    <label class="col-md-3 control-label label-filter text-right" for="province">จังหวัด: </label>
                                                    <div class="col-md-9 m-t-10">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center" id="province" name="province" >
                                                            <option selected value="{{$old_provinces->PROVINCE_ID??null}}">{{$old_provinces->PROVINCE_NAME??null}}</option>
                                                ...
                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="amphur">อำเภอ/เขต: </label>
                                                    <div class="col-md-9 m-t-10">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center" id="amphur" name="amphur" >
                                                            <option selected value="{{$old_amphur->AMPHUR_ID??null}}">{{$old_amphur->AMPHUR_NAME??null}}</option>
                                                        </select>
                                                    </div>
                                                </div>

                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="district">ตำบล/แขวง: </label>
                                                    <div class="col-md-9 m-t-10">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center" id="district" name="district" >
                                                            <option selected value="{{$old_district->DISTRICT_ID??null}}">{{$old_district->DISTRICT_NAME??null}}</option>
                                                        </select>
                                                    </div>
                                                </div>

                                                <div class="col-md-12 m-t-10">
                                                    <label class="col-md-3 control-label label-filter text-right" for="tel">เบอร์โทรศัพท์: </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control " id="tel" name="tel" value="{{$auditor->tel}}" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 m-t-10" style="padding-bottom: 20px">
                                                    <label class="col-md-3 control-label label-filter text-right" for="email">E-mail: </label>
                                                    <div class="col-md-9">
                                                        <input type="email" class="form-control" id="email" name="email" value="{{$auditor->email}}" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control text-center" id="regis_number" name="regis_number" readonly value="{{$auditor->number_auditor}}" }}>
                                                    </div>
                                                </div>

                                                <div class="col-md-12 m-t-10">
                                                    @php $departments = \App\Models\Basic\Department::where('state',1)->get() @endphp
                                                    <label class="col-md-4 control-label label-filter text-right" for="department">หน่วยงาน: </label>
                                                    <div class="col-md-8 ">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center" id="department" name="department" >
                                                            <option selected value="{{$auditor->department->id}}">{{$auditor->department->title}}</option>
                                                ...
                                                <div class="col-md-12 m-t-10 m-b-20">
                                                    <label class="col-md-4 control-label label-filter text-right" for="position">ตำแหน่ง: </label>
                                                    <div class="col-md-8 ">
                                                        <input type="text" class="form-control " id="position" name="position" value="{{$auditor->position}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 m-t-10">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                @if ($auditor->status_ab == 1)
                                                                    <input type="checkbox" id="choice" class="form-control" name="choice" checked>
                                                                @else
                                                ...
                                                <div class="col-md-12 m-t-10 m-b-20"  id="group_space">
                                                    <label class="col-md-4 control-label label-filter text-right" for="group">กลุ่ม:  </label>
                                                    <div class="col-md-8 ">
                                                        <select class="form-control col-md-9 setBorder custom-select mr-sm-2 text-center " id="group" name="group" >
                                                            <option selected value="0">- เลือกกลุ่ม -</option>
                                                ...
                                                <div class="col-md-12 m-t-10 m-b-20">
                                                    ...
                                                    <div class="col-md-8 ">
                                                        <div class="switch" style="margin-top: 10px">
                                                            ...
                                                            @else
                                                                <label>{!! Form::radio('onOrOff', '1', false, ['class'=>'check', 'data-radio'=>'iradio_square-green']) !!} เปิด</label>
                                                                <label>{!! Form::radio('onOrOff', '0', true, ['class'=>'check', 'data-radio'=>'iradio_square-red']) !!} ปิด</label>
                                                            @endif
                                ...
                                <ul class="pager wizard">
                                    ...
                                    {{-- <li class="finish" style="display:none;"><button type="button" class="pull-right btn btn-default" id="submit_form">บันทึก</button></li> --}}
...
{{--    <script src="{{ asset('plugins/components/jasny-bootstrap/js/jasny-bootstrap.js') }}"></script>--}}
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var testtttt = '{!! $auditor->group_id !!}'
            console.log(testtttt);

            if (testtttt !== "") {
                $('#group').val({!! $auditor->group_id !!}).change();
            }
            ...
            if (arr_check_labexam.length !== 0){
                console.log('LABEXAMMMM');
                $('#tableCheckLabExam').fadeIn();
                addCheckToTableLabExam();
            }
            if (arr_check_labtest.length !== 0){
                console.log('LABTESTTTT');
                $('#tableCheckLabTest').fadeIn();
                addCheckToTableLabTest();
            }
