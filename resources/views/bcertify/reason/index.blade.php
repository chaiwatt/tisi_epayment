            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                        ...
                        @can('add-'.str_slug('bcertify-reason'))
                            <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/reason/create') }}">
                    ...
                    <div class="row ">
                      ...
                      <div class="col-md-2">
                              {!! Form::select('filter_condition',
                                 ['1'=>'ใช้งาน','2'=>'ไม่ใช้งาน'], 
                                null, 
                                ['class' => 'form-control', 
                                'id'=>'filter_condition',
                                'placeholder' => '- เลือกเงื่อนไขอ้างอิง -']); !!}
                      </div><!-- /.col-md-2 -->
                      <div class="col-md-2">
                          <div class="  pull-left">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <tr>
                              ...
                              <th class="text-center" width="20%">เหตุผลและความจำเป็น</th>
                              <th class="text-center" width="10%">เงื่อนไขอ้างอิง</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/bcertify/reason/data_list') !!}',
                    data: function (d) {
                      
                        d.filter_search = $('#filter_search').val();
                        d.filter_state = $('#filter_state').val();
                        d.filter_condition = $('#filter_condition').val();
                    }
                }, 
                columns: [
            ...
            $( "#filter_clear" ).click(function() {
              $('#filter_search').val('');
              $('#filter_state,#filter_condition').val('').select2();
              table.draw();
