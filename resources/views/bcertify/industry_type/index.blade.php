...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "รหัส ISIC:"; }
    td:nth-of-type(4):before { content: "ประเภทอุตสาหกรรม:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ประเภทอุตสาหกรรม (ISIC)</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('industry_type'))
                      ...
                      @can('add-'.str_slug('industry_type'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/industry_type/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('industry_type'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/industry_type', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/industry_type/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/industry_type/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('code', 'รหัส ISIC')</th>
																<th>@sortablelink('title', 'ประเภทอุตสาหกรรม')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('industry_type'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/industry_type/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('industry_type'))
                                            <a href="{{ url('/bcertify/industry_type/' . $item->id) }}"
                                               title="View industry_type" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('industry_type'))
                                            <a href="{{ url('/bcertify/industry_type/' . $item->id . '/edit') }}"
                                               title="Edit industry_type" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('industry_type'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/industry_type', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete industry_type',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $industry_type->appends(['search' => Request::get('search'),
