...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "ชื่อสถานะผู้ตรวจประเมิน:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สถานะผู้ตรวจประเมิน</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('status_auditor'))
                      ...
                      @can('add-'.str_slug('status_auditor'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/status_auditor/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('status_auditor'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/status_auditor', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/status_auditor/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/status_auditor/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อสถานะผู้ตรวจประเมิน')</th>
                                <th>@sortablelink('kind', 'ประเภท')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('status_auditor'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/status_auditor/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('status_auditor'))
                                            <a href="{{ url('/bcertify/status_auditor/' . $item->id) }}"
                                               title="View status_auditor" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('status_auditor'))
                                            <a href="{{ url('/bcertify/status_auditor/' . $item->id . '/edit') }}"
                                               title="Edit status_auditor" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('status_auditor'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/status_auditor', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete status_auditor',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $status_auditor->appends(['search' => Request::get('search'),
