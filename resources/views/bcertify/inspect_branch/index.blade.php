...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "สาขาการตรวจ:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สาขาการตรวจ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('inspect_branch'))
                      ...
                      @can('add-'.str_slug('inspect_branch'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/inspect_branch/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('inspect_branch'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/inspect_branch', 'method' => 'get', 'id' => 'myFilter']) !!}
                      ...
                      <div class="col-md-6">
                          {!! Form::label('filter_inspect_category', 'หมวดหมู่การตรวจ:', ['class' => 'col-md-4 control-label label-filter']) !!}
                          <div class="col-md-8">
                            {!! Form::select('filter_inspect_category', App\Models\Bcertify\InspectCategory::pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder'=>'-เลือกหมวดหมู่การตรวจ-', 'onchange'=>'this.form.submit()']); !!}
                          </div>
                      </div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/inspect_branch/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/inspect_branch/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'สาขาการตรวจ')</th>
                                <th>@sortablelink('inspect_category_id', 'หมวดหมู่การตรวจ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('inspect_branch'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/inspect_branch/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('inspect_branch'))
                                            <a href="{{ url('/bcertify/inspect_branch/' . $item->id) }}"
                                               title="View inspect_branch" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('inspect_branch'))
                                            <a href="{{ url('/bcertify/inspect_branch/' . $item->id . '/edit') }}"
                                               title="Edit inspect_branch" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('inspect_branch'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/inspect_branch', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete inspect_branch',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $inspect_branch->appends(['search' => Request::get('search'),
