...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(4):before { content: "ความหมาย"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ประเภทการตรวจ (IB)</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('inspect_type'))
                      ...
                      @can('add-'.str_slug('inspect_type'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/inspect_type/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('inspect_type'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/inspect_type', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/inspect_type/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/inspect_type/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ประเภท')</th>
                                <th>@sortablelink('description', 'ความหมาย')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('inspect_type'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/inspect_type/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('inspect_type'))
                                            <a href="{{ url('/bcertify/inspect_type/' . $item->id) }}"
                                               title="View inspect_type" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('inspect_type'))
                                            <a href="{{ url('/bcertify/inspect_type/' . $item->id . '/edit') }}"
                                               title="Edit inspect_type" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('inspect_type'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/inspect_type', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete inspect_type',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $inspect_type->appends(['search' => Request::get('search'),
