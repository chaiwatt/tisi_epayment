...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "รหัส IAF:"; }
    td:nth-of-type(4):before { content: "รายละเอียด:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">IAF Code</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('iaf'))
                      ...
                      @can('add-'.str_slug('iaf'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/iaf/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('iaf'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/iaf', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/iaf/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/iaf/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('code', 'รหัส IAF')</th>
                                <th>@sortablelink('tiitle', 'รายละเอียดอุตสาหกรรม')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('view-'.str_slug('iaf'))
                                            <a href="{{ url('/bcertify/iaf/' . $item->id) }}"
                                               title="View iaf" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('iaf'))
                                            <a href="{{ url('/bcertify/iaf/' . $item->id . '/edit') }}"
                                               title="Edit iaf" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $iaf->appends(['search' => Request::get('search'),
