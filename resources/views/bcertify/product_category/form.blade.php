...
<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
  {!! Form::label('title', 'ชื่อหมวดหมู่ผลิตภัณฑ์ (TH):', ['class' => 'col-md-4 control-label']) !!}
  <div class="col-md-6">
...
<div class="form-group {{ $errors->has('title_en') ? 'has-error' : ''}}">
  {!! Form::label('title_en', 'ชื่อหมวดหมู่ผลิตภัณฑ์ (EN):', ['class' => 'col-md-4 control-label']) !!}
  <div class="col-md-6">
...
<div class="form-group {{ $errors->has('test_branch_id') ? 'has-error' : ''}}">
  {!! Form::label('test_branch_id', 'สาขาทดสอบ:', ['class' => 'col-md-4 control-label']) !!}
  <div class="col-md-6">
...
<div class="form-group">
  <div class="col-md-offset-4 col-md-4">
    ...
    <a class="btn btn-default" href="{{url('/bcertify/product_category')}}">
