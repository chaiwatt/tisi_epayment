...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "ชื่อหมวดหมู่:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">หมวดหมู่ผลิตภัณฑ์</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('product_category'))
                      ...
                      @can('add-'.str_slug('product_category'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/product_category/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('product_category'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/product_category', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/product_category/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/product_category/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อหมวดหมู่ผลิตภัณฑ์')</th>
                            ...
                            @foreach($product_category as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->title.' ('.$item->title_en.')' }}</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('product_category'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/product_category/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('product_category'))
                                            <a href="{{ url('/bcertify/product_category/' . $item->id) }}"
                                               title="View product_category" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('product_category'))
                                            <a href="{{ url('/bcertify/product_category/' . $item->id . '/edit') }}"
                                               title="Edit product_category" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('product_category'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/product_category', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete product_category',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $product_category->appends(['search' => Request::get('search'),
