...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "รายการทดสอบ:"; }
    td:nth-of-type(4):before { content: "สาขาการทดสอบ:"; }
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('test_item'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/test_item/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('test_item'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/test_item', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/test_item/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/test_item/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อรายการทดสอบ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('test_item'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/test_item/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('test_item'))
                                            <a href="{{ url('/bcertify/test_item/' . $item->id) }}"
                                               title="View test_item" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('test_item'))
                                            <a href="{{ url('/bcertify/test_item/' . $item->id . '/edit') }}"
                                               title="Edit test_item" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('test_item'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/test_item', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete test_item',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $test_item->appends(['search' => Request::get('search'),
