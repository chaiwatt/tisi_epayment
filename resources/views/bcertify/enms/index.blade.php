...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "Enms:"; }
    td:nth-of-type(4):before { content: "รหัส ISIC:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Enms</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('enms'))
                      ...
                      @can('add-'.str_slug('enms'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/enms/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('enms'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/enms', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/enms/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/enms/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('enms'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/enms/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('enms'))
                                            <a href="{{ url('/bcertify/enms/' . $item->id) }}"
                                               title="View enm" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('enms'))
                                            <a href="{{ url('/bcertify/enms/' . $item->id . '/edit') }}"
                                               title="Edit enm" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $enms->appends(['search' => Request::get('search'),
