...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "ชื่อผลิตภัณฑ์:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">รายการผลิตภัณฑ์</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('product_item'))
                      ...
                      @can('add-'.str_slug('product_item'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/product_item/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('product_item'))
                    ...
                    {!! Form::model($filter, ['url' => '/bcertify/product_item', 'method' => 'get', 'id' => 'myFilter']) !!}
                      ...
                      <div class="col-md-4">
                          {!! Form::label('filter_test_branch', 'สาขา:', ['class' => 'col-md-4 control-label label-filter']) !!}
                          <div class="col-md-8">
                            {!! Form::select('filter_test_branch', App\Models\Bcertify\TestBranch::pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder'=>'-เลือกสาขา-', 'onchange'=>'this.form.submit()']); !!}
                          </div>
                      </div>

                      <div class="col-md-4">
                          {!! Form::label('filter_product_category', 'หมวดหมู่:', ['class' => 'col-md-4 control-label label-filter']) !!}
                          <div class="col-md-8">
                            {!! Form::select('filter_product_category', App\Models\Bcertify\ProductCategory::pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder'=>'-เลือกหมวดหมู่-', 'onchange'=>'this.form.submit()']); !!}
                          </div>
                      </div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bcertify/product_item/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bcertify/product_item/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('product_category_id', 'หมวดหมู่ผลิตภัณฑ์')</th>
                                <th>@sortablelink('test_branch_id', 'สาขาการทดสอบ')</th>
                                <th>@sortablelink('formula_id', 'มาตรฐาน')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('product_item'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bcertify/product_item/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('product_item'))
                                            <a href="{{ url('/bcertify/product_item/' . $item->id) }}"
                                               title="View product_item" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('product_item'))
                                            <a href="{{ url('/bcertify/product_item/' . $item->id . '/edit') }}"
                                               title="Edit product_item" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('product_item'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bcertify/product_item', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete product_item',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $product_item->appends(['search' => Request::get('search'),
