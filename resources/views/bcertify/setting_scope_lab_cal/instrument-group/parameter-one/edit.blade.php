...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">แก้ไขพารามิเตอร์1 #{{$calibrationBranchParam1->name}}</h3>
                    ...
                    {!! Form::open(['url' => '/bcertify/setting_scope_lab_cal/instrument-group/parameter-one/update/'.$calibrationBranchParam1->id, 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('name', $calibrationBranchParam1->name, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
