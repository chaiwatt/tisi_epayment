...
<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
  {!! Form::label('title', 'หมวดหมู่การตรวจ (TH):', ['class' => 'col-md-4 control-label']) !!}
  <div class="col-md-6">
...
<div class="form-group {{ $errors->has('title_en') ? 'has-error' : ''}}">
  {!! Form::label('title_en', 'หมวดหมู่การตรวจ (EN):', ['class' => 'col-md-4 control-label']) !!}
  <div class="col-md-6">
...
<div class="form-group">
  <div class="col-md-offset-4 col-md-4">
    ...
    <a class="btn btn-default" href="{{url('/bcertify/inspect_category')}}">
