...
<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
  {!! Form::label('title', 'หมวดหมู่รายการสอบเทียบ:', ['class' => 'col-md-4 control-label']) !!}
  <div class="col-md-6">
...
<div class="form-group {{ $errors->has('calibration_branch_id') ? 'has-error' : ''}}">
  ...
  <div class="col-md-6">
    {!! Form::select('calibration_branch_id', $calibration_brachs, null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'-เลือกสาขาการสอบเทียบ-']) !!}
...
<div class="form-group">
  <div class="col-md-offset-4 col-md-4">
    ...
    <a class="btn btn-default" href="{{url('/bcertify/calibration_group')}}">
