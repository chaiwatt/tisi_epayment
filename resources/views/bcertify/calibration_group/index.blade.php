...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(4):before { content: "สาขา:"; }
    td:nth-of-type(5):before { content: "มาตรฐาน:"; }
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="white-box">
        <h3 class="box-title pull-left">หมวดหมู่รายการสอบเทียบ</h3>

        <div class="pull-right">

          @can('edit-'.str_slug('calibration_group'))
          ...
          @can('add-'.str_slug('calibration_group'))
          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bcertify/calibration_group/create') }}">
            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
          </a>
          @endcan

          @can('delete-'.str_slug('calibration_group'))
        ...
        {!! Form::model($filter, ['url' => '/bcertify/calibration_group', 'method' => 'get', 'id' => 'myFilter']) !!}
        ...
        <div class="table-responsive">
          ...
          {!! Form::open(['url' => '/bcertify/calibration_group/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

          {!! Form::close() !!}

          {!! Form::open(['url' => '/bcertify/calibration_group/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
          ...
          <table class="table table-borderless" id="myTable">
            <thead>
              <tr>
                ...
                <th>@sortablelink('title', 'ชื่อหมวดหมู่รายการสอบเทียบ')</th>
            ...
            <tbody>
              @foreach($calibration_group as $item)
              <tr>
                ...
                <td>
                  ...
                  {!! Form::open([
                  'method'=>'PUT',
                  'url' => ['/bcertify/calibration_group/update-state'],
                ...
                <td>
                  ...
                  <a href="{{ url('/bcertify/calibration_group/' . $item->id) }}" title="View calibration_group" class="btn btn-info btn-xs">
                    <i class="fa fa-eye" aria-hidden="true"></i>
                  </a>
                  @endcan

                  @can('edit-'.str_slug('calibration_group'))
                  <a href="{{ url('/bcertify/calibration_group/' . $item->id . '/edit') }}" title="Edit calibration_group" class="btn btn-primary btn-xs">
                  ...
                  {!! Form::open([
                  'method'=>'DELETE',
                  'url' => ['/bcertify/calibration_group', $item->id],
                  'style' => 'display:inline'
                  ]) !!}
                  {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                  'type' => 'submit',
                  'class' => 'btn btn-danger btn-xs',
                  'title' => 'Delete calibration_group',
          ...
          <div class="pagination-wrapper">
            {!!
            $calibration_group->appends(['search' => Request::get('search'),
