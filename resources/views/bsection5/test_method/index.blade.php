...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">วิธีทดสอบ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('testmethod'))
                      ...
                      @can('add-'.str_slug('testmethod'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bsection5/test_method/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('testmethod'))
                    ...
                    {!! Form::model($filter, ['url' => '/bsection5/test_method', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bsection5/test_method/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bsection5/test_method/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                              ...
                              <th>@sortablelink('title', 'วิธีทดสอบ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('testmethod'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bsection5/test_method/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('testmethod'))
                                            <a href="{{ url('/bsection5/test_method/' . $item->id) }}"
                                               title="View TestMethod" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('testmethod'))
                                            <a href="{{ url('/bsection5/test_method/' . $item->id . '/edit') }}"
                                               title="Edit TestMethod" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('testmethod'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bsection5/test_method', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete TestMethod',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $testmethod->appends(['search' => Request::get('search'),
