...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">หน่วย</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('bsection5-unit'))
                      ...
                      @can('add-'.str_slug('bsection5-unit'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bsection5/basic/unit/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('bsection5-unit'))
                    ...
                    {!! Form::model($filter, ['url' => '/bsection5/basic/unit', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bsection5/basic/unit/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bsection5/basic/unit/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อหน่วย')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('bsection5-unit'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bsection5/basic/unit/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('bsection5-unit'))
                                            <a href="{{ url('/bsection5/basic/unit/' . $item->id) }}"
                                               title="View Unit" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('bsection5-unit'))
                                            <a href="{{ url('/bsection5/basic/unit/' . $item->id . '/edit') }}"
                                               title="Edit Unit" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('bsection5-unit'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bsection5/basic/unit', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $unit->appends(['search' => Request::get('search'),
