...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">มาตรฐานรับรองระบบงาน</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('bsection5-standard'))
                      ...
                      @can('add-'.str_slug('bsection5-standard'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/bsection5/standards/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('bsection5-standard'))
                    ...
                    {!! Form::model($filter, ['url' => '/bsection5/standards', 'method' => 'get', 'id' => 'myFilter']) !!}

                        <div class="row">
                            <div class="col-md-10 form-group">
                                {!! Form::label('filter_text', 'ค้นหา :', ['class' => 'col-md-2 control-label text-right']) !!}
                                <div class="col-md-10">
                                    {!! Form::text('filter_text', null, ['class' => 'form-control', 'placeholder'=>'ค้นหาจากเลข มอก. , รายละเอียด']) !!}
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-10 form-group">
                                {!! Form::label('title', 'ประเภทมาตรฐาน :', ['class' => 'col-md-2 control-label text-right']) !!}
                                <div class="col-md-4">
                                    {!! Form::select('filter_standard_type', ['1' => 'IB', '2' => 'CB'], null, ['class' => 'form-control', 'placeholder'=>'-เลือกประเภทมาตรฐาน-']) !!}
                                </div>
                                {!! Form::label('title', 'สถานะ :', ['class' => 'col-md-2 control-label text-right']) !!}
                                <div class="col-md-4">
                                    {!! Form::select('filter_state', ['1'=>'เปิดใช้งาน', '0'=>'ปิดใช้งาน'], null, ['class' => 'form-control', 'placeholder'=>'-เลือกสถานะ-']); !!}
                                </div>
                            </div>
                            <div class="col-md-2">
                                <button type="submit" class="btn btn-info waves-effect waves-light" style="margin-right: 3%;">ค้นหา</button>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/bsection5/standards/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/bsection5/standards/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'เลข มอก.')</th>
                                <th>@sortablelink('description', 'รายละเอียด')</th>
                                <th>@sortablelink('standard_type', 'ประเภท มอก.')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('bsection5-standard'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/bsection5/standards/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('bsection5-standard'))
                                            <a href="{{ url('/bsection5/standards/' . $item->id) }}"
                                        ...
                                        @can('edit-'.str_slug('bsection5-standard'))
                                            <a href="{{ url('/bsection5/standards/' . $item->id . '/edit') }}"
                                               title="Edit Standard" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('bsection5-standard'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/bsection5/standards', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $standard->appends(['search' => Request::get('search'),
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#filter_clear').click(function(event) {
                let myFilter = $('#myFilter');
                myFilter.find('input, select').val('').change();
