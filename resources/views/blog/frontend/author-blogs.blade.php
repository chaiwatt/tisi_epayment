...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left"><i class="fa fa-user"></i> {{$author->FullName}}</h3>
                        ...
                        @foreach($blogs as $blog)
                            ...
                            <div class="details-wrapper">
                                ...
                                @if(!is_null($blog->author))
                                    <a href="{{url('blogs/author/'.$blog->author->getKey())}}">
                                        <span class="label label-success">Author : {{$blog->author->FullName}}</span>
                                    </a>
                                @endif
