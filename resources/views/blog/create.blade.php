    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    @can('add-blog')
                        <h3 class="box-title pull-left">เพิ่มข่าวใหม่</h3>
                        @can('view-blog')
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" data-role="tagsinput"
                                                           placeholder="เพิ่มแท็กที่นี่" value="{{old('tags')}}" name="tags">
                                                </div>
                                                <div class="col-md-4 text-right">
                                                    <button type="submit" class="btn btn-info waves-effect waves-light ">
                                                        <i class="icon-paper-plane"></i> ประกาศข่าว
                                                    </button>
                                                    <button type="reset" class="btn btn-danger waves-effect waves-light ">
                                                        <i class="icon-trash"></i> ล้างค่า
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
