...
<div class="col-md-7">
  <div class="white-box">
    ...
    <h3 class="box-title m-b-0">แก้ไขข้อมูลผู้ใช้งาน</h3>
    <p class="text-muted m-b-30 font-13"> แก้ไขข้อมูลผู้ประกอบการผู้ใช้งาน </p>
...
<div class="form-group">
  <div class="col-md-offset-4 col-md-4">
    ...
    <a class="btn btn-default" href="{{url('/basic/trader')}}">
