  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "ชื่อขั้นตอนการดำเนินงาน"; }
		td:nth-of-type(4):before { content: "ชื่อย่อ"; }
		td:nth-of-type(5):before { content: "สถานะงบประมาณ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ขั้นตอนการดำเนินงาน</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('status_operation'))
                      ...
                      @can('add-'.str_slug('status_operation'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/status_operation/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('status_operation'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/status_operation', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/status_operation/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/status_operation/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อขั้นตอนการดำเนินงาน')</th>
                                <th>@sortablelink('acronym', 'ชื่อย่อ')</th>
                                <th>@sortablelink('budget_state', 'สถานะงบประมาณ')</th>
                            ...
                            <tbody>
                            @foreach($status_operation as $item)
                                <tr>
                                    ...
                                    <td>
                                      @can('edit-'.str_slug('status_operation'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/status_operation/update-budget_state'],
                                          ...
                                          @if($item->budget_state=='1')

                                            {!! Form::hidden('budget_state', 0) !!}
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('status_operation'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/status_operation/update-state'],
                                                'style' => 'display:inline'
                                              ])
                                          !!}
                                    ...
                                    <td>
                                        @can('view-'.str_slug('status_operation'))
                                            <a href="{{ url('/basic/status_operation/' . $item->id) }}"
                                               title="View status_operation" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('status_operation'))
                                            <a href="{{ url('/basic/status_operation/' . $item->id . '/edit') }}"
                                               title="Edit status_operation" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('status_operation'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/status_operation', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete status_operation',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $status_operation->appends(['search' => Request::get('search'),
