  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "ชื่ออุตสาหกรรม"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">อุตสาหกรรมเป้าหมาย</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('industry_target'))
                      ...
                      @can('add-'.str_slug('industry_target'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/industry_target/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('industry_target'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/industry_target', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/industry_target/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/industry_target/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่ออุตสาหกรรมเป้าหมาย')</th>
                            ...
                            <tbody>
                            @foreach($industry_target as $item)
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('industry_target'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/industry_target/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('industry_target'))
                                            <a href="{{ url('/basic/industry_target/' . $item->id) }}"
                                               title="View industry_target" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('industry_target'))
                                            <a href="{{ url('/basic/industry_target/' . $item->id . '/edit') }}"
                                               title="Edit industry_target" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('industry_target'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/industry_target', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete industry_target',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $industry_target->appends(['search' => Request::get('search'),
