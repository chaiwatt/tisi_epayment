  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "ชื่อหมวดส่งเสริมผู้ประกอบการ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">หมวดส่งเสริมผู้ประกอบการ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('promote_trader'))
                      ...
                      @can('add-'.str_slug('promote_trader'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('basic/promote_trader/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('promote_trader'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/promote_trader', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/promote_trader/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/promote_trader/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อหมวดส่งเสริมผู้ประกอบการ')</th>
                            ...
                            <tbody>
                            @foreach($promote_trader as $item)
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('promote_trader'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/promote_trader/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('promote_trader'))
                                            <a href="{{ url('/basic/promote_trader/' . $item->id) }}"
                                               title="View promote_trader" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('promote_trader'))
                                            <a href="{{ url('/basic/promote_trader/' . $item->id . '/edit') }}"
                                               title="Edit promote_trader" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('promote_trader'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/promote_trader', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete promote_trader',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $promote_trader->appends(['search' => Request::get('search'),
