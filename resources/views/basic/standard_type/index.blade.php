	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(3):before { content: "ชื่อประเภท(TH)"; }
		td:nth-of-type(4):before { content: "ชื่อประเภท(EN)"; }
		td:nth-of-type(5):before { content: "ตัวย่อ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ประเภทมาตรฐาน</h3>
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('standard_type'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/standard_type/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('standard_type'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/standard_type', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/standard_type/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/standard_type/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อประเภทมาตรฐาน(TH)')</th>
																<th>@sortablelink('title_en', 'ชื่อประเภทมาตรฐาน(EN)')</th>
																<th>@sortablelink('acronym', 'ตัวย่อ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('standard_type'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/standard_type/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('standard_type'))
                                            <a href="{{ url('/basic/standard_type/' . $item->id) }}"
                                               title="View standard_type" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('standard_type'))
                                            <a href="{{ url('/basic/standard_type/' . $item->id . '/edit') }}"
                                               title="Edit standard_type" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('standard_type'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/standard_type', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete standard_type',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $standard_type->appends(['search' => Request::get('search'),
