...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ชื่อรายการไฟล์แนบ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('set_attach'))
                      ...
                      @can('add-'.str_slug('set_attach'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/set_attach/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('set_attach'))
                    ...
                    <hr>
										...
										{!! Form::model($filter, ['url' => '/basic/set_attach', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/set_attach/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/set_attach/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อไฟล์แนบ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('set_attach'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/set_attach/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('set_attach'))
                                            <a href="{{ url('/basic/set_attach/' . $item->id) }}"
                                               title="View set_attach" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('set_attach'))
                                            <a href="{{ url('/basic/set_attach/' . $item->id . '/edit') }}"
                                               title="Edit set_attach" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('set_attach'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/set_attach', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete set_attach',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $set_attach->appends(['search' => Request::get('search'),
