	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(3):before { content: "วิธีจัดทำ"; }
		td:nth-of-type(4):before { content: "รายละเอียดย่อย"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">วิธีจัดทำ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('method'))
                      ...
                      @can('add-'.str_slug('method'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/method/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('method'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/method', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/method/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/method/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">@sortablelink('title', 'วิธีจัดทำ')</th>
                                <th class="text-center">@sortablelink('details', 'รายละเอียดย่อย')</th>
                                <th class="text-center">@sortablelink('period', 'ระยะเวลา')</th>
                            ...
                            @foreach($method as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td>
                                    <td>{{ $item->details }}</td>
                                    <td>{{ !empty($item->period) ? $item->period.' เดือน' : ''  }}</td>
                                    ...
                                    <td>
                                        @can('view-'.str_slug('method'))
                                            <a href="{{ url('/basic/method/' . $item->id) }}"
                                               title="View method" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('method'))
                                            <a href="{{ url('/basic/method/' . $item->id . '/edit') }}"
                                               title="Edit method" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $method->appends(['search' => Request::get('search'),
