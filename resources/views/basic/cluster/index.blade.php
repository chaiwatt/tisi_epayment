  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "ชื่อสถานะของมาตรฐาน"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">สถานะของมาตรฐาน</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('cluster'))
                      ...
                      @can('add-'.str_slug('cluster'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/cluster/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('cluster'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/cluster', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/cluster/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/cluster/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อสถานะของมาตรฐาน')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('cluster'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/cluster/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('cluster'))
                                            <a href="{{ url('/basic/cluster/' . $item->id) }}"
                                               title="View cluster" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('cluster'))
                                            <a href="{{ url('/basic/cluster/' . $item->id . '/edit') }}"
                                               title="Edit cluster" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $cluster->appends(['search' => Request::get('search'),
