...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="white-box">
        <h3 class="box-title pull-left">ข้อมูลพื้นฐานความเชี่ยวชาญ</h3>

        <div class="pull-right">

          @can('edit-'.str_slug('expertgroups'))
          ...
          @can('add-'.str_slug('expertgroups'))
          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/expert-groups/create') }}">
            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
          </a>
          @endcan

          @can('delete-'.str_slug('expertgroups'))
        ...
        <div class="table-responsive">
          ...
          {!! Form::open(['url' => 'basic/expert-groups/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

          {!! Form::close() !!}

          {!! Form::open(['url' => 'basic/expert-groups/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {!! Form::open([
                  'method'=>'PUT',
                  'url' => ['/basic/expert-groups/update-state'],
                ...
                <td>
                  ...
                  <a href="{{ url('/basic/expert-groups/' . $item->id) }}" title="View ExpertGroup" class="btn btn-info btn-xs">
                    <i class="fa fa-eye" aria-hidden="true"></i>
                  </a>
                  @endcan

                  @can('edit-'.str_slug('expertgroups'))
                  <a href="{{ url('/basic/expert-groups/' . $item->id . '/edit') }}" title="Edit ExpertGroup" class="btn btn-primary btn-xs">
                  ...
                  {!! Form::open([
                  'method'=>'DELETE',
                  'url' => ['/basic/expert-groups', $item->id],
                  'style' => 'display:inline'
                  ]) !!}
                  {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                  'type' => 'submit',
                  'class' => 'btn btn-danger btn-xs',
                  'title' => 'Delete ExpertGroup',
          ...
          <div class="pagination-wrapper">
            {!!
            $expertgroups->appends(['search' => Request::get('search'),
