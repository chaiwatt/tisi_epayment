  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "ชื่อภาค"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ภาค</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('Geography'))
                      ...
                      @can('add-'.str_slug('Geography'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/geography/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('Geography'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/geography', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/geography/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/geography/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('GEO_NAME', 'ชื่อภาค')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('Geography'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/geography/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('Geography'))
                                            <a href="{{ url('/basic/geography/' . $item->getKey()) }}"
                                               title="View Geography" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('Geography'))
                                            <a href="{{ url('/basic/geography/' . $item->getKey() . '/edit') }}"
                                               title="Edit Geography" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('Geography'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/geography', $item->getKey()],
                                                            'style' => 'display:inline'
                                            ]) !!}
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $geography->appends(['search' => Request::get('search'),
