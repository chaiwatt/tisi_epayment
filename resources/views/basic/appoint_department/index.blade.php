...
<style>
  ...
  /*
	...
	*/
    ...
    td:nth-of-type(3):before { content: "ชื่อหน่วยงาน"; }
    td:nth-of-type(4):before { content: "เบอร์โทร"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">หน่วยงานสำหรับแต่งตั้งกรรมการ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('appoint_department'))
                      ...
                      @can('add-'.str_slug('appoint_department'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/appoint_department/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('appoint_department'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/appoint_department', 'method' => 'get', 'id' => 'myFilter']) !!}
                      <div class="row">
                        ...
                        <div class="form-group col-md-5">
												  ...
												  <div class="col-md-9">
														{!! Form::text('filter_search', null, ['class' => 'form-control', 'placeholder'=>'ค้นจากชื่อหน่วยงาน, เบอร์โทร', 'onchange'=>'this.form.submit()']); !!}
												  </div>
											  </div>
                      </div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/appoint_department/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/appoint_department/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อหน่วยงาน')</th>
                            ...
                            <tbody>
                            @foreach($appoint_department as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                      ...
                                      @can('edit-'.str_slug('appoint_department'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/appoint_department/update-state'],
                                    ...
                                    <td class="text-center">
                                        @can('view-'.str_slug('appoint_department'))
                                            <a href="{{ url('/basic/appoint_department/' . $item->id) }}"
                                               title="View appoint_department" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('appoint_department'))
                                            <a href="{{ url('/basic/appoint_department/' . $item->id . '/edit') }}"
                                               title="Edit appoint_department" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('appoint_department'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/appoint_department', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete appoint_department',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $appoint_department->appends(['search' => Request::get('search'),
