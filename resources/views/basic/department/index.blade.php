                ...
                <div class="white-box">
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('department'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/department/create') }}">
                    ...
                    {!! Form::model($filter, ['url' => '/basic/department', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/department/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/department/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('department_type', 'ประเภทหน่วยงาน')</th>
                            ...
                            @foreach($department as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td>
                                    <td>@foreach ($item->department_type_list as $key => $department_types)@if($key!=0), @endif{{ HP::DepartmentTypes()[$department_types->department_type_id] }}@endforeach</td>
                                    <td>{{ $item->tel }}</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('department'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/department/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('department'))
                                            <a href="{{ url('/basic/department/' . $item->id) }}"
                                               title="View department" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('department'))
                                            <a href="{{ url('/basic/department/' . $item->id . '/edit') }}"
                                               title="Edit department" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $department->appends(['search' => Request::get('search'),
