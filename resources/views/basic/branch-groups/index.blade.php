...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">หมวดสาขา/สาขา</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('branchgroup'))
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อหมวดสาขา/สาขา')</th>
                                <th>@sortablelink('category', 'หมวดสาขา')</th>
                                    ...
                                    <td>
                                        @can('view-'.str_slug('branchgroup'))
                                            <a href="{{ url('/basic/branch-groups/' . $item->id) }}"
                                               title="View BranchGroup" class="btn btn-info btn-xs">
                                        ...
                                        @can('edit-'.str_slug('branchgroup'))
                                            <a href="{{ url('/basic/branch-groups/' . $item->id . '/edit') }}"
                                               title="Edit BranchGroup" class="btn btn-primary btn-xs">
