	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(3):before { content: "รหัสจังหวัด"; }
		td:nth-of-type(4):before { content: "ชื่อจังหวัด"; }
		td:nth-of-type(5):before { content: "ภาค"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">จังหวัด</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('province'))
                      ...
                      @can('add-'.str_slug('province'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/province/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('province'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/province', 'method' => 'get', 'id' => 'myFilter']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 form-group">
                                ...
                                <div class="col-md-10">
                                    {!! Form::text('search', null, ['class' => 'form-control', 'placeholder' => 'ค้นจาก รหัสจังหวัดหรือชื่อจังหวัด']); !!}
                                </div>
                            </div>
                        ...
                        <div id="advance-box" class="panel-collapse collapse row">
                            <div class="white-box" style="display:flow-root;">
                                ...
                                <div class="col-md-4">
                                    {!! Form::label('filter_geo', 'ภาค:', ['class' => 'col-md-3 control-label label-filter']) !!}
        							<div class="col-md-9">
        							    {!! Form::select('filter_geo', App\Models\Basic\Geography::pluck('GEO_NAME', 'GEO_ID'), null, ['class' => 'form-control', 'placeholder'=>'-เลือกสถานะ-']); !!}
        							</div>
        						</div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/province/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/province/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('PROVINCE_CODE', 'รหัสจังหวัด')</th>
                                <th>@sortablelink('PROVINCE_NAME', 'ชื่อจังหวัด')</th>
                                <th>@sortablelink('GEO_ID', 'ภาค')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('province'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/province/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('province'))
                                            <a href="{{ url('/basic/province/' . $item->getKey()) }}"
                                               title="View province" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('province'))
                                            <a href="{{ url('/basic/province/' . $item->getKey() . '/edit') }}"
                                               title="Edit province" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('province'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/province', $item->getKey()],
                                                            'style' => 'display:inline'
                                            ]) !!}
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $province->appends($filter)->render()
                          !!}
                        </div>
                    </div>
