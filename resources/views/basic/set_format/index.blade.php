  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "รูปแบบ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">รูปแบบการกำหนดมาตรฐาน</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('set_format'))
                      ...
                      @can('add-'.str_slug('set_format'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/set_format/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('set_format'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/set_format', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/set_format/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/set_format/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อรูปแบบการกำหนดมาตรฐาน')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('set_format'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/set_format/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('set_format'))
                                            <a href="{{ url('/basic/set_format/' . $item->id) }}"
                                               title="View set_format" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('set_format'))
                                            <a href="{{ url('/basic/set_format/' . $item->id . '/edit') }}"
                                               title="Edit set_format" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('set_format'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/set_format', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete set_format',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $set_format->appends(['search' => Request::get('search'),
