...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">รายสาขา</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('branch'))
                      ...
                      @can('add-'.str_slug('branch'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/branches/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('branch'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/branches', 'method' => 'get', 'id' => 'myFilter']) !!}

						<div class="row">
							<div class="col-md-2">
								<div class="form-group">
									{!! Form::label('perPage', 'Show:', ['class' => 'control-label label-filter']) !!}
							...
							<div class="col-md-3">
								<div class="form-group">
								{!! Form::label('filter_branch_groups', 'หมวดสาขา/สาขา:', ['class' => 'control-label label-filter']) !!}
									{!! Form::select('filter_branch_groups', BranchGroup::whereState(1)->pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder'=>'-เลือกหมวดสาขา/สาขา-', 'onchange'=>'this.form.submit()']); !!}
								</div>
							</div>

							<div class="col-md-3">
								<div class="form-group">
								{!! Form::label('title', 'สถานะ:', ['class' => 'control-label label-filter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/branches/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/branches/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อรายสาขา')</th>
                                <th>@sortablelink('branch_group_id', 'หมวดสาขา/สาขา')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('branch'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/branches/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('branch'))
                                            <a href="{{ url('/basic/branches/' . $item->id) }}"
                                               title="View Branch" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('branch'))
                                            <a href="{{ url('/basic/branches/' . $item->id . '/edit') }}"
                                               title="Edit Branch" class="btn btn-primary btn-xs">
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $branch->appends(['search' => Request::get('search'),
