  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No."; }
		...
		td:nth-of-type(3):before { content: "รหัสตำบล"; }
		td:nth-of-type(4):before { content: "ชื่อตำบล"; }
		td:nth-of-type(5):before { content: "อำเภอ"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ตำบล</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('district'))
                      ...
                      @can('add-'.str_slug('district'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/district/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('district'))
                    ...
                    {!! Form::model($filter, ['url' => '/basic/district', 'method' => 'get', 'id' => 'myFilter']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 form-group">
                                ...
                                <div class="col-md-10">
                                    {!! Form::text('search', null, ['class' => 'form-control', 'placeholder' => 'ค้นจาก รหัสตำบลหรือชื่อตำบล']); !!}
                                </div>
                            </div>
                        ...
                        <div id="advance-box" class="panel-collapse collapse row">
                            <div class="white-box" style="display:flow-root;">
                                ...
                                <div class="col-md-4">
                                    {!! Form::label('filter_amphur', 'อำเภอ:', ['class' => 'col-md-3 control-label label-filter']) !!}
        							<div class="col-md-9">
        							    {!! Form::select('filter_amphur', !empty($filter['filter_province']) ? App\Models\Basic\Amphur::where('PROVINCE_ID', $filter['filter_province'])->orderby('AMPHUR_NAME')->pluck('AMPHUR_NAME', 'AMPHUR_ID') : [], null, ['class' => 'form-control', 'placeholder'=>'-เลือกสถานะ-']); !!}
        							</div>
        						</div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/district/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/district/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('DISTRICT_CODE', 'รหัสตำบล')</th>
                                <th>@sortablelink('DISTRICT_NAME', 'ชื่อตำบล')</th>
                                <th>@sortablelink('AMPHUR_ID', 'อำเภอ')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('district'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/district/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('district'))
                                            <a href="{{ url('/basic/district/' . $item->getKey()) }}"
                                               title="View district" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('district'))
                                            <a href="{{ url('/basic/district/' . $item->getKey() . '/edit') }}"
                                               title="Edit district" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('district'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/district', $item->getKey()],
                                                            'style' => 'display:inline'
                                            ]) !!}
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $district->appends($filter)->render()
                          !!}
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#filter_province').change(function () {
                ...
                $('#filter_amphur').children(":not([value=''])").remove();
                ...
                $.ajax({
                    ...
                    'success': function (datas) {
                        ...
                        $.each(datas, function(index, data) {
                            $('#filter_amphur').append('<option value="'+index+'">'+data+'</option>');
                        });
                        $('#filter_amphur').select2();
                    }
                });
