...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">กลุ่มผลิตภัณฑ์/สาขา</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('product_group'))
                      ...
                      @can('add-'.str_slug('product_group'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/basic/product_group/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('product_group'))
                    ...
                    <hr>
										...
										{!! Form::model($filter, ['url' => '/basic/product_group', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/basic/product_group/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/basic/product_group/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'ชื่อกลุ่มผลิตภัณฑ์/สาขา')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('product_group'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/basic/product_group/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('product_group'))
                                            <a href="{{ url('/basic/product_group/' . $item->id) }}"
                                               title="View product_group" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('product_group'))
                                            <a href="{{ url('/basic/product_group/' . $item->id . '/edit') }}"
                                               title="Edit product_group" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('product_group'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/basic/product_group', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete product_group',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $product_group->appends(['search' => Request::get('search'),
