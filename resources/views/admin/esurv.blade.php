        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    @foreach ( $controller->AllMenuESurv() as $menu )
                    ...
                    @if( count( $controller->AllMenuESurv() ) == 0 )
                        <div class="alert alert-info"> <i class="fa fa-exclamation-circle"></i> คุณไม่มีสิทธิ์ใช้งานส่วนนี้ </div>
                    @endif
