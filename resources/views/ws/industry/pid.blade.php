<div class="row">
    ...
    <div class="col-md-12 item">
        ...
        <div class="col-md-7">{{ number_format($factory->CAP, 2) }} บาท</div>
    </div>

    <div class="col-md-12 item">
        <div class="col-md-2"></div>
        <div class="col-md-3">จำนวนคนงาน:</div>
        <div class="col-md-7">{{ number_format($factory->WORKS) }}</div>
    </div>
    ...
    <div class="col-md-12 item">
        ...
        <div class="col-md-7">{{ $factory->INDUST_TYPE }}</div>
    </div>
    ...
    <div class="col-md-12 item">
        ...
        <div class="col-md-7">{{ $factory->COLONY_INDUST_DESC }}</div>
    </div>
    ...
    <div class="col-md-12 item">
        ...
        <div class="col-md-7">{{ $factory->SOI }}</div>
    </div>

    <div class="col-md-12 item">
        <div class="col-md-2"></div>
        <div class="col-md-3">ถนน:</div>
        <div class="col-md-7">{{ $factory->ROAD }}</div>
    </div>

    <div class="col-md-12 item">
        <div class="col-md-2"></div>
        <div class="col-md-3">ตำบล:</div>
        <div class="col-md-7">{{ $factory->TUMNAME }}</div>
    </div>

    <div class="col-md-12 item">
        <div class="col-md-2"></div>
        <div class="col-md-3">อำเภอ:</div>
        <div class="col-md-7">{{ $factory->AMPNAME }}</div>
    </div>

    <div class="col-md-12 item">
        <div class="col-md-2"></div>
        <div class="col-md-3">จังหวัด:</div>
        <div class="col-md-7">{{ $factory->PRONAME }}</div>
    </div>

    <div class="col-md-12 item">
        <div class="col-md-2"></div>
        <div class="col-md-3">รหัสไปรษณีย์:</div>
        <div class="col-md-7">{{ $factory->ZIPCODE }}</div>
    </div>
    ...
    <div class="col-md-12 item">
        ...
        <div class="col-md-7">
            @if (!is_null($factory->LATITUDE) && !is_null($factory->LONGITUDE))
                <a data-toggle="modal" data-target="#modal-map-show" style="cursor: pointer;">{{ $factory->LATITUDE }}, {{ $factory->LONGITUDE }}</a>
            @else
...
@push('js')
    @if(isset($factory) && !is_null($factory->LATITUDE) && !is_null($factory->LONGITUDE))
        ...
        <script>
            ...
            var markers   = [];
            var latitude  = {{ $factory->LATITUDE }};
            var longitude = {{ $factory->LONGITUDE }};
