@php
    $certify = App\Models\Certify\ApplicantIB\CertiIBExport::find($certificate->certificate_id);
@endphp
...
<div class="form-group {{ $errors->has('name_unit') ? 'has-error' : ''}}">
    ...
    <div class="col-md-8">
        <div class="  input-group">
            {!! Form::text('name_unit',  !empty( $certify->name_unit)? $certify->name_unit:null, ['class' => 'form-control','id'=>'name_unit','required' => true]) !!}
...
<div class="form-group {{ $errors->has('name_unit_en') ? 'has-error' : ''}}">
    <div class="col-md-offset-3 col-md-8">
        <div class="input-group">
            {!! Form::text('name_unit_en',  !empty( $certify->name_unit_en)? $certify->name_unit_en:null, ['class' => 'form-control','id'=>'name_unit_en','required' => true]) !!}
...
<div class="form-group {{ $errors->has('date_end') ? 'has-error' : ''}}">
    ...
    <div class="col-md-3">
        {!! Form::text('date_end', !empty( $certify->date_end)? HP::revertDate($certify->date_end,true):null, ['class' => 'form-control','id'=>'date_end','disabled' => true ]) !!}
    ...
    <script>
        ...
        function radio_address(){
            ...
            if( $.inArray( checked , [1,2]) ){  
                $.ajax({
                    url: "{!! url('cerreport/logesignaures/get-address') !!}" + "?id=" + id    + "&address=" +   checked
