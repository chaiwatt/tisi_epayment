...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ระบบบันทึกการดำเนินการทางกฏหมาย (สำหรับเจ้าหน้าที่กฏหมาย)</h3>
                  
                    <div class="pull-right">
                      {{-- <div class="alert alert-success">{{!empty($ControlCheck->auto_id_doc)?$ControlCheck->auto_id_doc:null}}yyy</div> --}}
                      @can('edit-'.str_slug('LawOperation'))
                      ...
                      @can('add-'.str_slug('LawOperation'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('esurv/law-operation/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('LawOperation'))
                    ...
                    {!! Form::model($filter, ['url' => '/law-operation', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/law-operation/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/law-operation/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>เลขที่เอกสาร</th><th>เลข มอก.</th><th>เลขที่ใบอนุญาต</th><th>การดำเนินการผู้ประกอบการ/<br>ใบอนุญาต</th><th>การดำเนินการกับผลิตภัณฑ์</th>
                                <th>@sortablelink('state', 'สถานะ')</th>
                                <th>จัดการ</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($lawoperation as $item)
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('LawOperation'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/law-operation/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('LawOperation'))
                                            <a href="{{ url('esurv/law-operation/' . $item->id) }}"
                                               title="View LawOperation" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('LawOperation'))
                                            <a href="{{ url('esurv/law-operation/' . $item->id . '/edit') }}"
                                               title="Edit LawOperation" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('LawOperation'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/law-operation', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete LawOperation',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $lawoperation->appends(['search' => Request::get('search'),
