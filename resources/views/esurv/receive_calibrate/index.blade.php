        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    {!! Form::model($filter, ['url' => '/esurv/receive_calibrate', 'method' => 'get', 'id' => 'myFilter']) !!}
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <div class="col-md-12">
                                ...
                                {!! Form::select('filter_created_by',
                                                App\Models\Esurv\ReceiveCalibrate::select(DB::raw("CONCAT($sso_user_table.name) AS title"), "$sso_user_table.id")
                                                    ->Join($sso_user_table, "$sso_user_table.id", '=', 'esurv_inform_calibrates.created_by')
                                                    ->distinct('esurv_inform_calibrates.created_by')
                                                    ->pluck('title','id'),
                                                null,
                  ...
                  <div id="search-btn" class="panel-collapse collapse">
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/esurv/receive_calibrate/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/esurv/receive_calibrate/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                            ...
                            @foreach($receive_calibrate as $item)
                              <tr>
                                 ...
                                 @else
                                    ...
                                    @if($user_tis->first()=='All' ||  (!empty($item->tis->tb3_Tisno)  && in_array($item->tis->tb3_Tisno, $user_tis_list)))
                                        <a href="{{ url('/esurv/receive_calibrate/' . $item->id) }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $( "#filter_clear" ).click(function() {
                ...
                window.location.assign("{{url('/esurv/receive_calibrate')}}");
            });
