...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">บันทึกการตรวจติดตามผล</h3>
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>1/62</td>
                                    <td>บริษัท อมตะธานีจำกัด</td>
                                    <td>เหล็กกล้าคาร์บอนทรงแบนรีดร้อน สำหรับงานทั่วไปและงานขึ้นรูป</td>
                                    <td>528-2548</td>
                                    <td>528-14/2387, 528-16/2387, 528-18/2387</td>
                                    <td>01-ม.ค.-2562</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="cb[]" class="cb" value="1"></td>
                                    <td>2/62</td>
                                    <td>บริษัท กรุงเทพเหล็ก จำกัด</td>
                                    <td>เหล็กกล้าคาร์บอนทรงแบนรีดร้อน สำหรับงานโครงสร้างเครื่องจักรกล</td>
                                    <td>1501-2552</td>
                                    <td>1501-14/2387, 1501-16/2387, 1501-18/2387</td>
                                    <td>01-ก.พ.-2562</td>
                                    <td>ศิริชัย ภู่ภักดี</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="cb[]" class="cb" value="1"></td>
                                    <td>3/62</td>
                                    <td>บริษัท เหล็กทรัพย์ จำกัด</td>
                                    <td>เหล็กกล้าทรงแบนรีดร้อน สำหรับงานโครงสร้างทั่วไป</td>
                                    <td>1479-2558</td>
                                    <td>1479-14/2387, 1479-16/2387, 1479-18/2387</td>
                                    <td>01-มี.ค.-2562</td>
                                    <td>ศิริชัย ภู่ภักดี</td>
