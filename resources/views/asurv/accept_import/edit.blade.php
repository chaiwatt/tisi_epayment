                ...
                <div class="white-box">
                                    ...
                                    <div class="form-group {{ $errors->has('attach_hiring_book') ? 'has-error' : ''}} clearfix">
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept_import/download/'.$attach_hiring_book->file_name)}}">{{$attach_hiring_book->file_client_name}}</a> --}}
                                     ...
                                     <div class="form-group {{ $errors->has('attach_drawing') ? 'has-error' : ''}} clearfix">
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept_import/download/'.$attach_drawing->file_name)}}">{{$attach_drawing->file_client_name}}</a> --}}
                    ...
                    <form id="form_data" method="post" enctype="multipart/form-data">
                        ...
                        @if ($data->state == '4')
                          ...
                          <a  href="{{  url('/asurv/accept_import')  }}"  class="btn btn-default btn-sm waves-effect waves-light btn-block">
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            @if(HP_API_PID::check_api('check_api_asurv_accept_import') && HP_API_PID::CheckDataApiPid($data, (new App\Models\Asurv\EsurvBiss20)->getTable()) != '' &&  $data->state === 1)

                var id    = '{!! $data->id !!}';
                var table = '{!! (new App\Models\Asurv\EsurvBiss20)->getTable() !!}';
