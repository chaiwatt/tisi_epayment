...
@section('content')
 ...
 <br class="clearfix"/>
                    ...
                    <form id="form_data" method="post" enctype="multipart/form-data">
                        ...
                        @if ($data->state == '4')
                                <br>
                                <a  href="{{  url('/asurv/accept_export')  }}"  class="btn btn-default btn-sm waves-effect waves-light btn-block">
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if( HP_API_PID::check_api('check_api_asurv_accept_export') && HP_API_PID::CheckDataApiPid($data, (new App\Models\Asurv\EsurvTers20)->getTable()) != '' && $data->state === 1 )
                
                var id    = '{!! $data->id !!}';
                var table = '{!! (new App\Models\Asurv\EsurvTers20)->getTable() !!}';
