                ...
                <div class="row">
                    ...
                    <fieldset class="row">
                        <div class="white-box">
                            <div class="form-group">
                                {!! Form::model($filter, ['url' => '/asurv/report21own_import', 'method' => 'get', 'id' => 'myFilter']) !!}
                                <div class="row">
                 ...
                 <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                ...
                                @endphp
                                @foreach($report21own_import as $list)
                                    <tr>
                                        <td>{{$temp_num++}}.</td>
                                        <td>{{ !empty($list->esurv_ters21_to->ref_no) ?   $list->esurv_ters21_to->ref_no : null }}</td>
                                        <td>{{HP::get_name_4($list->created_by)}}</td>
                                        <td>{{ !empty($list->esurv_ters21_to->title) ?   $list->esurv_ters21_to->title : null }}</td>
                                        ...
                                        <td>
                                            @if(in_array('All', $user_tis_list)  || in_array(@$list->TisName, $user_tis_list) )
                                                 <a href="{{url("/asurv/report21own_import/$list->id/edit")}}"><span
                            ...
                            <div class="pagination-wrapper">
                                ...
                                @endphp
                                {!!
                                    $report21own_import->appends($page)->links()
                                !!}
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $( "#filter_clear" ).click(function() {
                ...
                window.location.assign("{{url('/asurv/report21own_import')}}");
            });
