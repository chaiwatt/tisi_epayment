                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr class="hr-line bg-primary">
                                ...
                                {!! Form::model($filter, ['url' => '/asurv/report_import', 'method' => 'get', 'id' => 'myFilter']) !!}
                 ...
                 <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 8%;">วันที่ผลิต</th>
                                ...
                                @endphp
                                @foreach($report_import as $list)
                                    <tr>
                                        <td>{{$temp_num++}}.</td>
                                        <td>{{HP::get_ref_no2_4($list->applicant_20bis_id)}}</td>
                                        <td>{{HP::get_name_4($list->created_by)}}</td>
                                        <td>{{HP::get_title2_4($list->applicant_20bis_id)}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url("/asurv/report_import/$list->id/edit")}}"><span
                            ...
                            <div class="pagination-wrapper">
                                ...
                                @endphp
                                {!!
                                    $report_import->appends($page)->links()
                                !!}
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $( "#filter_clear" ).click(function() {
                ...
                window.location.assign("{{url('/asurv/report_import')}}");
            });
