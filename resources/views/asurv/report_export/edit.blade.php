        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="box-title">ระบบรับแจ้งปริมาณการทำผลิตภัณฑ์เพื่อส่งออก (20 ตรี)</h1>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-8 ">
                                        <input type="text" class="form-control" disabled
                                               value="{{HP::get_ref_no1_4($data->applicant_20ter_id)}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" disabled
                                               value="{{HP::get_title1_4($data->applicant_20ter_id)}}">
                                    </div>
                                    <div class="col-sm-2 text-right">ระยะเวลาที่แจ้งผลิต</div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" disabled
                                               value="{{ HP::DateThai(HP::get_date_start_4($data->applicant_20ter_id)) }} - {{ HP::DateThai(HP::get_date_end_4($data->applicant_20ter_id)) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
{{--                                            <input value="{{$data->start_date}}" type="text" class="form-control"--}}
{{--                                                   id="datepicker-time" disabled/>--}}
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group">
                                            <input value="{{$data->end_date}}" type="text" class="form-control"
                            ...
                            <div class="table-responsive">
                                <table class="table color-bordered-table primary-bordered-table" id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2"  style="width: 8%;">รวมปริมาณการส่งออก</th>
                                        <th style="width: 8%;">ปริมาณการส่งออก</th>
                                    ...
                                    ?>
                                        ...
                                        @php
                                            ...
                                            foreach ($item->informed as $informed) {
                                                if($informed->volume_20ter_id!=$data->id  && $informed->volume_20ter_id < $data->id){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" disabled value="{{ $item->detail }}"></td>
                                            <td>
                                                 <input type="text" class="form-control " value="{{ number_format($sum_informed) }}" disabled>
                                            </td>
                                            <td>
                                                    <input  disabled  type="checkbox" value="1" @if(array_key_exists($item->id, $volume_20ter_details)) checked="checked" @endif>
                                                    <label for="detail-2"> ผลิต </label>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control " value="{{ array_key_exists($item->id, $volume_20ter_details) ? $volume_20ter_details[$item->id] : null   }}" disabled>
                                            </td>
                                            <td>{{ $item->data_unit->name_unit  ?? null }}</td>
                                        </tr>
                                    @endforeach
                                        ...
                                        <div class="other_attach_item">
                                            ...
                                            <div class="col-md-3">
                                                <div class="fileinput fileinput-new input-group pull-left col-md-10" data-provides="fileinput">
                                                    <div >
                                                        {{-- <a href="{{url('/asurv/report_export/download/'.$attach->file_name)}}">{{$attach->file_client_name}}</a> --}}
                                            ...
                                            <div class="col-md-2">
                                                    {{-- <a href="{{url('/asurv/report_export/preview/'.$attach->file_name)}}" target="_blank" class="view-attach btn btn-info btn-sm"><i class="fa fa-search"></i></a> --}}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive"   >
                                            <table class="table color-bordered-table primary-bordered-table"  style="display: block;
                                                ...
                                                <thead>
                                                <tr>
                                                    <th  width="2%" >รายการที่</th>
                                                    <th   width="15%" >รายละเอียดผลิตภัณฑ์อุตสาหกรรม</th>
                                                    <th   width="8%" >ปริมาณที่ขอส่งออก</th>
                                                    @foreach($data_volume_main as $list)
                                                        <th   width="4%">
                                                            <a href="{{url("/asurv/report_export/$list->id/edit")}}" style="color:White"  target="_blank" >  
                                                ...
                                                @foreach($applicant_20ter_details as $key => $item)
                                                    @php
                                                        ...
                                                        $sum            = 0;
                                                        // foreach ($item->informed as $informed) {
                                                        //     if($informed->volume_20ter_id!=$data->id){
                                                        //         $sum_informed += $informed->quantity;
                                                        //     }
                                                        // }
                                                    @endphp
                                                    <tr>
                                                        <td>{{$key +1 }}</td>
                                                        <td>
                                                            <input type="text" class="form-control" disabled value="{{ $item->detail }}"  >
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control text-center"   value="{{@HP::get_quantity_4($item->id)}}" disabled >
                                                        </td>
                                                        @foreach($data_volume_main as  $list)
                                                            @php
                                                               $sum_detail = HP::get_sum_quantity1_4($list->id,$item->id) ?? 0;
                                                               $sum    += !empty($sum_detail) ? $sum_detail : 0;
                                                            @endphp
                                                            <td>
                                                                <input type="text"   class="form-control "   disabled    value="{{ number_format($sum_detail,2)}}"  style="width:150px">
                                                            </td>
                                                        @endforeach
                                                        <td><input type="text"       class="form-control "  disabled value="{{  number_format($sum,2) }}" style="width:150px">
                                                        </td>
                                                         <td>
                                                             {{ $item->data_unit->name_unit  ?? null }}
                                                        </td>
                                                    </tr>
                            ...
                            <div class="col-md-12" id="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6 m-b-10">
                                                    <textarea name="remark_officer_report" id="remark_officer_report" rows="4" cols="50"  class="form-control">{{$data->remark_officer_report}} </textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12" style="margin-bottom: 5px;"></div>
                                  ...
                                  @if ($data->state_notify_report == '1')
                                            <br>
                                            <a  href="{{  url('/asurv/report_export')  }}"  class="btn btn-default btn-sm waves-effect waves-light btn-block">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            if($('#state_notify_report').val() == '1'){ 
                ...
                $('#remark_officer_report').prop('disabled', true);
            }
	    });
        ...
        $('#form_data').on('submit', function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('/asurv/report_export/save')}}",
                datatype: "script",
                data: form_data,
                contentType: false,
                cache: false,
                ...
                success: function (data) {
                    if (data.status == "success") {
                        window.location.href = "{{url('/asurv/report_export')}}"
