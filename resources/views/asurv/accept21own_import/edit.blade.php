        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="box-title">ระบบรับคำขอการนำเข้าผลิตภัณฑ์เพื่อนำมาใช้เอง (21)</h1>
                            ...
                            <div class="white-box">
                                <fieldset>
                                    ...
                                    <div class="form-group {{ $errors->has('attach_product_plan') ? 'has-error' : ''}}">
                                        {!! Form::label('attach_product_plan', 'แผนการผลิต ระยะเวลาการทำ', ['class' => 'col-md-5 control-label required']) !!}
                                            ...
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach_product_plan->file_name)}}">{{$attach_product_plan->file_client_name}}</a> --}}
                                    ...
                                    <div class="form-group {{ $errors->has('attach_hiring_book') ? 'has-error' : ''}} clearfix">
                                        {!! Form::label('attach_hiring_book', 'สำเนาหนังสือสัญญาว่าจ้าง/สัญญาการสั่งซื้อ/ข้อตกลงการว่าจ้าง/ใบสั่งซื้อสินค้า', ['class' => 'col-md-5 control-label required']) !!}
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach_hiring_book->file_name)}}">{{$attach_hiring_book->file_client_name}}</a> --}}
                                    ...
                                    <div class="form-group {{ $errors->has('attach_factory_license') ? 'has-error' : ''}} clearfix">
                                        {!! Form::label('attach_factory_license', 'สำเนาใบอนุญาตประกอบกิจการโรงงาน', ['class' => 'col-md-5 control-label required']) !!}
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach_factory_license->file_name)}}">{{$attach_factory_license->file_client_name}}</a> --}}
                                    ...
                                    <div class="form-group {{ $errors->has('attach_standard_to_made') ? 'has-error' : ''}} clearfix">
                                        {!! Form::label('attach_standard_to_made', 'สำเนามาตรฐานของต่างประเทศหรือมาตรฐานระหว่างประเทศ ที่ใช้ทำผลิตภัณฑ์', ['class' => 'col-md-5 control-label required']) !!}
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach_standard_to_made->file_name)}}">{{$attach_standard_to_made->file_client_name}}</a> --}}
                                    ...
                                    <div class="form-group {{ $errors->has('attach_difference_standard') ? 'has-error' : ''}} clearfix">
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach_difference_standard->file_name)}}">{{$attach_difference_standard->file_client_name}}</a> --}}
                                     ...
                                     <div class="form-group {{ $errors->has('attach_drawing') ? 'has-error' : ''}} clearfix">
                                        {!! Form::label('attach_drawing', 'สำเนาแบบ (Drawing) ที่ใช้ในการผลิต เฉพาะส่งที่เกี่ยวข้องเกี่ยวกับผลิตภัณฑ์ที่ขอทำ', ['class' => 'col-md-5 control-label required']) !!}
                                        ...
                                        <div class="col-md-7">
                                            <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                ...
                                                <div class="form-control" data-trigger="fileinput">
                                                    <span class="input-group">
                                                        {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach_drawing->file_name)}}">{{$attach_drawing->file_client_name}}</a> --}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="fileinput fileinput-new input-group pull-left col-md-10"
                                                            ...
                                                            <div class="form-control">
                                                                <div>
                                                                    {{-- <a href="{{url('/asurv/accept21own_import/download/'.$attach->file_name)}}">{{$attach->file_client_name}}</a> --}}
                    ...
                    <form id="form_data" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12" style="margin-bottom: 5px;"></div>
                            @if ($data->state == '4')
                                    <br>
                                    <a  href="{{  url('/asurv/accept21own_import')  }}"  class="btn btn-default btn-sm waves-effect waves-light btn-block">
                            ...
                            @else
                                <div class="form-group text-center">
                                    ...
                                    href="{{ url('/asurv/accept21own_import') }}">
                                        <i class="fa fa-undo"></i><b> ยกเลิก</b>
                                    </a>
                                </div>
                            @endif
    ...
    <script>
         $(document).ready(function () {
            ...
            $('#form_data').on('submit', function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('/asurv/accept21own_import/save')}}",
                    datatype: "script",
                    data: form_data,
                    contentType: false,
                    cache: false,
                    ...
                    success: function (data) {
                        if (data.status == "success") {
                            window.location.href = "{{url('/asurv/accept21own_import')}}"
            ...
            @if(HP_API_PID::check_api('check_api_asurv_accept21own_import') && HP_API_PID::CheckDataApiPid($data, (new App\Models\Asurv\EsurvOwns21)->getTable()) != '' &&  $data->state === 1)
                var id    = '{!! $data->id !!}';
                var table = '{!! (new App\Models\Asurv\EsurvOwns21)->getTable() !!}';
