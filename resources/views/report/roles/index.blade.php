                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="h2 text-bold-600 text-center">รายงานการกำหนดสิทธิ์การใช้งานของแต่ละกลุ่มบทบาท</p>
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="40%" class="text-center">กลุ่มบทบาท</th>
                                        <th width="20%" class="text-center">ส่วนควบคุม</th>
                                        <th width="17%" class="text-center">จำนวนระบบที่ใช้งาน</th>
                                        <th width="17%" class="text-center">จำนวนผู้ใช้งาน</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/report/roles/data_list') !!}',
                    data: function (d) {
