        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left">รายงานทดสอบ LAB</h3>
                                    ...
                                    <div id="search-btn" class="panel-collapse collapse">
                                        <div class="white-box" style="display: flex; flex-direction: column;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form-group ">
                                                    <div class=" {{ $errors->has('filter_start_date') ? 'has-error' : ''}}">
                                                        {!! Form::label('filter_test_date', 'วันที่ทดสอบ'.' :', ['class' => 'col-md-12 control-label']) !!}
                                                        <div class="col-md-12">
                                                          <div class="input-daterange input-group" >
                                                            {!! Form::text('filter_test_date_start',null, ['class' => 'form-control mydatepicker', 'id' => 'filter_test_date_start', 'placeholder'=>'วว/ดด/ปปปป']) !!}
                                                            <span class="input-group-addon bg-info b-0 text-white"> ถึง </span>
                                                            {!! Form::text('filter_test_date_end', null, ['class' => 'form-control mydatepicker', 'id' => 'filter_test_date_end', 'placeholder'=>'วว/ดด/ปปปป']) !!}
                                                          </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <table class="table table-striped" id="myTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th vertical-align="top" class="text-center" width="10%">เลขที่ใบรับ-นำส่งตัวอย่าง</th>
                                            <th vertical-align="top" class="text-center" width="10%">จำนวนชุดตัวอย่าง</th>
                                            <th vertical-align="top" class="text-center" width="10%">วันที่รับตัวอย่าง</th>
                                            <th vertical-align="top" class="text-center" width="10%">วันที่ตรวจสอบเสร็จ</th>
                                            <th vertical-align="top" class="text-center" width="10%">ระยะเวลาทดสอบ (วัน)</th>
    ...
    <script>
        ...
        $(function () {
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/report/test-product/data_list') !!}',
                    data: function (d) {
                        ...
                        d.filter_test_date_start = $('#filter_test_date_start').val();
                        d.filter_test_date_end = $('#filter_test_date_end').val();
                    }
                },
                columns: [
                    {'data': 'DT_Row_Index', name: 'DT_Row_Index' , orderable: true},
                    {'data': 'lab_code', name: 'lab_code', orderable: false},
                    {'data': 'tis_no', name: 'tis_no', orderable: false},
                    {'data': 'trader_name', name: 'trader_name', orderable: false},
                    {'data': 'sample_bill_no', name: 'sample_bill_no', orderable: false},
                    {'data': 'total_sample_qty', name: 'total_sample_qty', orderable: false},
                    {'data': 'receive_date', name: 'receive_date', orderable: false},
                    {'data': 'test_finish_date', name: 'test_finish_date', orderable: false},
                    {'data': 'test_duration', name: 'test_duration', orderable: false},
                    {'data': 'action', name: 'action', orderable: false}
                ],
                columnDefs: [
                    { className: "text-center", targets:[0, 1, 2 ,-1, -2, -3, -4,-5] },
                ],
