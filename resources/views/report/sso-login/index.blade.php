...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">รายงานการลงชื่อเข้าใช้งานของผู้ประกอบการ</h3>

                    <div class="clearfix"></div>
                    <hr>

                    {!! Form::model($filter, ['url' => '/report/report-sso-login', 'method' => 'get', 'id' => 'myFilter']) !!}

                        <div class="row">
                            <div class="col-md-5 form-group">
                                  {!! Form::label('search', 'คำค้น:', ['class' => 'col-md-2 control-label label-filter']) !!}
                                  <div class="col-md-10">
                                        {!! Form::text('search', null, ['class' => 'form-control', 'placeholder' => 'ชื่อผู้ใช้งาน ชื่อผู้ประกอบการ หรือที่อยู่ IP']); !!}
                                  </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-borderless" id="myTable">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>@sortablelink('username', 'ชื่อผู้ใช้งาน')</th>
    								<th>@sortablelink('name', 'ชื่อผู้ประกอบการ')</th>
                            ...
                            <tbody>
                                @foreach($log as $item)
                                    <tr>
                                        ...
                                        <td class="text-top">{{ $item->username }}</td>
                                        <td class="text-top">{{ $item->name }}</td>
