            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                        ...
                        {{-- @can('add-'.str_slug('assessmentib'))
                            <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/certificate/assessment-ib/create') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/certificate/assessment-ib/data_list') !!}',
                    data: function (d) {
