...
{!! Form::open(['url' => 'certificate/tracking-cb/update_report/'.$report->id,    'method' => 'POST', 'class' => 'form-horizontal  ','id'=>'form_report', 'files' => true]) !!}
...
<input type="hidden" name="previousUrl" id="previousUrl" value="{{  url('certificate/tracking-cb/'.$certi->id.'/edit')  }}">
