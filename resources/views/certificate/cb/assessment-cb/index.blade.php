            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                        ...
                        {{-- @can('add-'.str_slug('assessmentcb'))
                            <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/certificate/assessment-cb/create') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/certificate/assessment-cb/data_list') !!}',
                    data: function (d) {
