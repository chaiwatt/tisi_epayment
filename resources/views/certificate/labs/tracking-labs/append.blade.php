...
@section('content')
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    @can('view-'.str_slug('trackinglabs'))
                        <a class="btn btn-success pull-right" href="{{url('/certificate/tracking-labs/'.$tracking->id.'/edit')}}">
    ...
    <div class="row">
                   ...
                   <div class="table-responsive">
                          ...
                          <table class="table color-bordered-table info-bordered-table"  id="myTable">
                              ...
                              @endphp
                                ...
                                @foreach ($certilab_file_all as $item)
                                    <tr>
       ...
       {!! Form::open(['url' => 'certificate/tracking-labs/update_append/'.$tracking->id,
