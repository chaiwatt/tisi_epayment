...
{!! Form::open(['url' => 'certificate/tracking-labs/update_report/'.$report->id,    'method' => 'POST', 'class' => 'form-horizontal  ','id'=>'form_report', 'files' => true]) !!}
            ...
            @else 
                    <div class="fileinput fileinput-new input-group m-t-10" data-provides="fileinput">
                        ...
                        <span class="input-group-addon btn btn-default btn-file">
                            ...
                            <input type="file" name="file_loa"  id="file_loa"  accept=".pdf" class="file_loa check_max_size_file" required>
                        </span>
...
<input type="hidden" name="previousUrl" id="previousUrl" value="{{  url('certificate/tracking-labs/'.$certi->id.'/edit')  }}">
