...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ระบบลงนามบันทึกข้อความ(ตรวจติดตาม)</h3>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/certificate/auditor-tracking-assignment/data-list') !!}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'tracking_ref', name: 'tracking_ref' },
        ...
        $(document).on('click', '#signDocument', function() {
            ...
            $.ajax({
                url: "{{ route('auditor_tracking_assignment.signDocument') }}",
                type: 'POST',
                data: { 
