...
<body>
    <div class="wrapper">
        ...
        <form id="labMessageForm" method="POST" action="{{ route('certificate.auditor-labs.save-tracking-lab-message-record',['id' => $id]) }}">
            ...
            <!-- Main Content -->
            <div class="section">
                <div>เรียน ผอ.สก. ผ่าน ผก.รป.<input type="text" class="input-no-border" id="body_text1" name="body_text1" value="{{$boardAuditorMsRecordInfo->body_text1}}" style="width:30px" ></div>
