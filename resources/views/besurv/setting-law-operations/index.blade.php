...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ระบบตั้งค่าการดำเนินการทางกฏหมาย</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('MasterLawOperation'))
                      ...
                      @can('add-'.str_slug('MasterLawOperation'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/setting-law-operations/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('MasterLawOperation'))
                    ...
                    {!! Form::model($filter, ['url' => '/setting-law-operations', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/setting-law-operations/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/setting-law-operations/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>ชื่อสถานะการดำเนินการ</th>
                                {{-- <th>State</th><th>Ordering</th><th>Created By</th><th>Updated By</th> --}}
                            ...
                            <tbody>
                            @foreach($masterlawoperations as $item)
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('MasterLawOperation'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/setting-law-operations/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('MasterLawOperation'))
                                            <a href="{{ url('/setting-law-operations/' . $item->id) }}"
                                               title="View MasterLawOperation" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('MasterLawOperation'))
                                            <a href="{{ url('/setting-law-operations/' . $item->id . '/edit') }}"
                                               title="Edit MasterLawOperation" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('MasterLawOperation'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/setting-law-operations', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete MasterLawOperation',
                        ...
                        <div class="pagination-wrapper">
                          ...
                          @endphp
                          {!!
                              $masterlawoperations->appends($page)->render()
                          !!}
                        </div>
                    </div>
