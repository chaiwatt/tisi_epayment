  ...
  /*
	...
	*/
    ...
    td:nth-of-type(1):before { content: "No.:"; }
		...
		td:nth-of-type(4):before { content: "ประเภท:"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">หน่วยงานตรวจ</h3>

                    <div class="pull-right">

                      @can('edit-'.str_slug('inspector'))
                      ...
                      @can('add-'.str_slug('inspector'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/besurv/inspector/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('inspector'))
                    ...
                    {!! Form::model($filter, ['url' => '/besurv/inspector', 'method' => 'get', 'id' => 'myFilter']) !!}
                      ...
                      <div class="col-md-3">
                          {!! Form::label('filter_inspector_type', 'ประเภท:', ['class' => 'col-md-3 control-label label-filter']) !!}
                          <div class="col-md-9">
                            {!! Form::select('filter_inspector_type', HP::InspectorTypes(), null, ['class' => 'form-control', 'placeholder'=>'-เลือกประเภท-', 'onchange'=>'this.form.submit()']); !!}
                          </div>
                      </div>

                      <div class="col-md-3">
                          {!! Form::label('filter_search', 'หน่วยงาน:', ['class' => 'col-md-5 control-label label-filter']) !!}
                          <div class="col-md-7">
                            {!! Form::text('filter_search', null, ['class' => 'form-control', 'onchange'=>'this.form.submit()']); !!}
                          </div>
                      </div>
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/besurv/inspector/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/besurv/inspector/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('title', 'หน่วยงาน')</th>
                            ...
                            @foreach($inspector as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td>
                                    <td>@foreach ($item->inspector_type_list as $key => $inspector_types)@if($key!=0), @endif{{ HP::InspectorTypes()[$inspector_types->inspector_type_id] }}@endforeach</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('inspector'))
                                          ...
                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/besurv/inspector/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('inspector'))
                                            <a href="{{ url('/besurv/inspector/' . $item->id) }}"
                                               title="View inspector" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('inspector'))
                                            <a href="{{ url('/besurv/inspector/' . $item->id . '/edit') }}"
                                               title="Edit inspector" class="btn btn-primary btn-xs">
