        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left text-primary">หน่วยงานต้นเรื่อง</h3>

                    <div class="pull-right">
                        @can('add-'.str_slug('law-departments'))
                            <a class="btn btn-success waves-effect waves-light" href="{{ url('/law/basic/department/create') }}">
                        ...
                        <div class="col-md-12"  id="BoxSearching">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-10">
                                            {!! Form::text('filter_search', null, ['class' => 'form-control ', 'id' => 'filter_search', 'title'=>'ค้นหา:ชื่อหน่วยงานต้นเรื่อง,ชื่อหน่วยงานต้นเรื่อง(ย่อ)']); !!}
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div id="search-btn" class="panel-collapse collapse">
                                ...
                                <div class="row">              
                                    <div class="form-group col-md-4">
                                        {!! Form::label('filter_type', 'ประเภทหน่วยงาน', ['class' => 'col-md-12 control-label']) !!}
                                        <div class="col-md-12">
                                            {!! Form::select('filter_type', ['1' => 'หน่วยงานภายใน','2' => 'หน่วยงานภายนอก'], null, ['class' => 'form-control ', 'placeholder'=>'- เลือกประเภทหน่วยงาน -', 'required' => true]) !!}
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="pull-right has-dropdown">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    @can('edit-'.str_slug('law-departments'))
                                        <li>
                                    ...
                                    @endcan
                                    @can('delete-'.str_slug('law-departments'))
                                        <li>
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="20%">ชื่อหน่วยงานต้นเรื่อง</th>
                                        <th class="text-center" width="15%">ชื่อหน่วยงานต้นเรื่อง(ย่อ)</th>
                                        <th class="text-center" width="20%">ประเภทหน่วยงาน</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/law/basic/department/data_list') !!}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'title_short', name: 'title_short' },
                    { data: 'type', name: 'type' },
                ...
                columnDefs: [
                    { className: "text-center text-top", targets:[1,-1,-2] },
            ...
            $(document).on('click', '.btn_update_state', function(e) {
                ...
                if (confirm("ยืนยันการ"+text_alert+ "ข้อมูลแถว นี้ ?")) {
                    ...
                    $.ajax({
                        method: "put",
                        url: "{{ url('law/basic/department/update-state') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "id_publish": ids,
                            "state": state
        ...
        function Delete(){
            ...
            if (ids.length > 0) {
                ...
                if(confirm("ยืนยันการลบข้อมูล " + ids.length + " แถว นี้ ?")){
                    ...
                    $.ajax({
                        method: "POST",
                        url: "{{ url('law/basic/department/delete') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "id_publish": ids,
                        }
