...
<div class="form-group required{{ $errors->has('title') ? 'has-error' : ''}}">
    {!! Form::label('title', 'ชื่อหมวดหมู่การดำเนินงาน', ['class' => 'col-md-4 control-label font-medium-6']) !!}
    <div class="col-md-6 ">
...
<div class="form-group">
    ...
    <div class="col-md-6 ">
        {!! Form::text('created_by_show', !empty($categoryoperation->created_by)? $categoryoperation->CreatedName:auth()->user()->Fullname, ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        {!! Form::text('created_by_show',  !empty($categoryoperation->created_at)? HP::revertDate($categoryoperation->created_at, true):HP::revertDate( date('Y-m-d'), true), ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('law-basic-category-operation'))
            <a class="btn btn-default show_tag_a"  href="{{ url('/law/basic/category-operation') }}">
        ...
        $(document).ready(function() {
            ...
            $('#myForm').submit(function() {
                ...
                if( $('#type_submit').val() == 1){
                    ...
                    $.ajax({
                        method: "POST",
                        url: "{{ url('/law/basic/category-operation/save_and_copy') }}",
                        data: formData,
                        contentType : false,
                        processData : false,
