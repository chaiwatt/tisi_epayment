...
<div class="form-group">
    ...
    <div class="col-md-6 ">
        {!! Form::text('created_by_show', !empty($bookgroup->created_by)? $bookgroup->CreatedName:auth()->user()->Fullname, ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        {!! Form::text('created_by_show',  !empty($bookgroup->created_at)? HP::revertDate($bookgroup->created_at, true):HP::revertDate( date('Y-m-d'), true), ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('law-book-group'))
            <a class="btn btn-default show_tag_a"  href="{{ url('/law/basic/book-group') }}">
        ...
        $(document).ready(function() {
            ...
            $('#myForm').submit(function() {
                ...
                if( $('#type_submit').val() == 1){
                    ...
                    $.ajax({
                        method: "POST",
                        url: "{{ url('/law/basic/book-group/save_and_copy') }}",
                        data: formData,
                        contentType : false,
                        processData : false,
