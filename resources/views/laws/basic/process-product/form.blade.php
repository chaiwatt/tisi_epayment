...
<div class="form-group required{{ $errors->has('title') ? 'has-error' : ''}}">
    {!! Form::label('title', 'การดำเนินการ', ['class' => 'col-md-4 control-label font-medium-6']) !!}
    <div class="col-md-6 ">
...
<div class="form-group">
    ...
    <div class="col-md-6 ">
        {!! Form::text('created_by_show', !empty($processproduct->created_by)? $processproduct->CreatedName:auth()->user()->Fullname, ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        {!! Form::text('created_by_show',  !empty($processproduct->created_at)? HP::revertDate($processproduct->created_at, true):HP::revertDate( date('Y-m-d'), true), ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('law-process-product'))
            <a class="btn btn-default show_tag_a"  href="{{ url('/law/basic/process-product') }}">
