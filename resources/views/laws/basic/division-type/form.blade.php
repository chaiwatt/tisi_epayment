...
<div class="form-group required{{ $errors->has('title') ? 'has-error' : ''}}">
    {!! Form::label('title', 'ประเภทการแบ่งเงิน', ['class' => 'col-md-4 control-label font-medium-6']) !!}
    <div class="col-md-6 ">
...
<div class="form-group">
    ...
    <div class="col-md-6 ">
        {!! Form::text('created_by_show', !empty($divisiontype->created_by)? $divisiontype->CreatedName:auth()->user()->Fullname, ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        {!! Form::text('created_by_show',  !empty($divisiontype->created_at)? HP::revertDate($divisiontype->created_at, true):HP::revertDate( date('Y-m-d'), true), ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('law-resource'))
            <a class="btn btn-default show_tag_a"  href="{{ url('/law/basic/division-type') }}">
