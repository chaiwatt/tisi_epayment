...
<div class="form-group">
    ...
    <div class="col-md-6 ">
        {!! Form::text('created_by_show', !empty($listentype->created_by)? $listentype->CreatedName:auth()->user()->Fullname, ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        {!! Form::text('created_by_show',  !empty($listentype->created_at)? HP::revertDate($listentype->created_at, true):HP::revertDate( date('Y-m-d'), true), ['class' => 'form-control ', 'disabled' => true]) !!}
    </div>
</div>
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('law-basic-listen-type'))
            <a class="btn btn-default show_tag_a"  href="{{ url('/law/basic/listen-type') }}">
        ...
        $(document).ready(function() {
            ...
            $('#myForm').submit(function() {
                ...
                if( $('#type_submit').val() == 1){
                    ...
                    $.ajax({
                        method: "POST",
                        url: "{{ url('/law/basic/listen-type/save_and_copy') }}",
                        data: formData,
                        contentType : false,
                        processData : false,
