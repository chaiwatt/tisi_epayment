            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                        @can('add-'.str_slug('law-offend-type'))
                            <a class="btn btn-success waves-effect waves-light" href="{{ url('/law/basic/offend-type/create') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-10">
                                            {!! Form::text('filter_search', null, ['class' => 'form-control ', 'id' => 'filter_search', 'title'=>'ค้นหา:สาเหตุที่พบกระทำความผิด']); !!}
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="col-md-12"> 
                            <div class="pull-right has-dropdown">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    @can('edit-'.str_slug('law-offend-type'))
                                        <li>
                                    ...
                                    @endcan
                                    @can('delete-'.str_slug('law-offend-type'))
                                        <li>
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="25%">สาเหตุที่พบกระทำความผิด</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/law/basic/offend-type/data_list') !!}',
                    data: function (d) {
            ...
            $(document).on('click', '.btn_update_state', function(e) {
                ...
                if (confirm("ยืนยันการ"+text_alert+ "ข้อมูลแถว นี้ ?")) {
                    ...
                    $.ajax({
                        method: "put",
                        url: "{{ url('law/basic/offend-type/update-state') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "id_publish": ids,
                            "state": state
        ...
        function Delete(){
            ...
            if (ids.length > 0) {
                ...
                if(confirm("ยืนยันการลบข้อมูล " + ids.length + " แถว นี้ ?")){
                    ...
                    $.ajax({
                        method: "POST",
                        url: "{{ url('law/basic/offend-type/delete') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "id_publish": ids,
                        }
