        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left">กำหนดสัดส่วนเงินรางวัลสินบน</h3>

                    <div class="pull-right">
                        @can('add-'.str_slug('law-config-reward'))
                            <a class="btn btn-success waves-effect waves-light" href="{{ url('/law/config/reward/create') }}">
                        ...
                        <div class="col-md-12">
                            <div class="pull-right has-dropdown">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    @can('edit-'.str_slug('law-config-reward'))
                                        <li>
                                    ...
                                    @endcan
                                    @can('delete-'.str_slug('law-config-reward'))
                                        <li>
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="8%">ชื่อกลุ่มที่กำหนด</th>
                                        <th class="text-center" width="25%">กลุ่มผู้มีสิทธิ์ได้รับเงิน</th>
                                        <th class="text-center" width="15%">มีการจับกุม (การดำเนินการ)</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/law/config/reward/data_list') !!}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'reward_group', name: 'reward_group' },
                    { data: 'arrest_and_operation', name: 'arrest_and_operation' },
            ...
            $(document).on('click', '.btn_update_state', function(e) {
                ...
                if (confirm("ยืนยันการ"+text_alert+ "ข้อมูลแถว นี้ ?")) {
                    ...
                    $.ajax({
                        method: "put",
                        url: "{{ url('law/config/reward/update-state') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "id_publish": ids,
                            "state": state
        ...
        function Delete(){
            ...
            if (ids.length > 0) {
                ...
                if(confirm("ยืนยันการลบข้อมูล " + ids.length + " แถว นี้ ?")){
                    ...
                    $.ajax({
                        method: "POST",
                        url: "{{ url('law/config/reward/delete') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "id_publish": ids,
                        }
