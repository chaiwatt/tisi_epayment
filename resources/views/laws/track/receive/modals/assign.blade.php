@php      
    ...
    //นิติกร
    $users            = App\User::selectRaw('runrecno AS id, reg_subdepart, CONCAT(reg_fname," ",reg_lname) As title')->get();    
            ...
            <div class="modal-body">
                <form id="form_assign" class="form-horizontal"  method="post" >
                    ...
                    <div class="form-group">
                        {!! HTML::decode(Form::label('assign_id', 'ผู้รับผิดชอบ', ['class' => 'col-md-3 control-label font-medium-6  text-right'])) !!}
                        <div class="col-md-6">
                            {!! Form::select('assign_id', [] , null, ['class' => 'form-control', 'id'=>"assign_id", 'required' => true,'placeholder'=>'- เลือกผู้รับผิดชอบ -']); !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {!! Form::label('status_show', 'ข้อมูล', ['class' => 'col-md-3 control-label font-medium-6']) !!}
                        <div class="col-md-9">
                            <div class="table">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" width="30%">เลขที่อ้างอิง</th>
                                        <th class="text-center" width="30%">เลขทึ่หนังสือ</th>
                    ...
                    {{-- <div class="form-group">
                        <div class="col-md-offset-3 col-md-10">
                            <div class="checkbox checkbox-primary">
                                ...
                                <label for="assign_checkall">มอบหมาย</label>
                           </div>
                        </div>
                    </div> --}}

                    <div class="form-group"> 
                        {!! HTML::decode(Form::label('lawyer_check', 'มอบหมายงาน', ['class' => 'col-md-3 control-label font-medium-6  text-right'])) !!}
                        <div class=" col-md-9">
                    ...
                    <div class="form-group lawyers_box">
                        {!! HTML::decode(Form::label('lawyers', 'ผู้รับมอบหมาย', ['class' => 'col-md-3 control-label font-medium-6  text-right'])) !!}
                        <div class="col-md-6">
                            {!! Form::select('lawyers', [] , null, ['class' => 'form-control', 'id'=>"lawyer_ids", 'required' => true,'placeholder'=>'- เลือกผู้รับมอบหมาย -']); !!}
                        </div>
                    </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#lawyer_ids').html('<option value=""> - เลือกผู้รับมอบหมาย - </option>');
            ...
            $('#assign_id').html('<option value=""> - เลือกผู้รับผิดชอบ - </option>');
            ...
            $('#form_assign').parsley().on('field:validated', function() {
                ...
                table.$('.item_checkbox:checked').each(function (index, rowId) {
                 ...
                 $.ajax({
                    method: "post",
                    url: "{{ url('law/track/receive/save_assign') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "ids": ids,
                        "id": $('#assigns_id').val(),
