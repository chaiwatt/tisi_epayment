...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ติดตามงาน (รายละเอียด)</h3>
                    @can('view-'.str_slug('law-track-views'))
                        <a class="btn btn-default pull-right" href="{{ url('/law/track/views') }}">
                    ...
                    {!! Form::model($lawtrackreceive, [
                        'method' => 'PATCH',
                        'url' => ['/law/track/views', $lawtrackreceive->id],
                        'class' => 'form-horizontal',
                        'files' => true,
                        'id' => 'box-readonly'
                    ]) !!}

                    @include ('laws.track.views.form')
