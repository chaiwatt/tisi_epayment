        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left ">สัดส่วนผู้มีสิทธิ์ได้รับเงิน</h3>

                    <div class="pull-right">
                           @can('add-'.str_slug('law-reward-reward'))
                                <a class="btn btn-success waves-effect waves-light" href="{{ url('/law/reward/reward/create') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="form-group col-md-6">
                                        {!! Form::select('filter_condition_search', array('1' => 'ชื่อกลุ่ม'), null, ['class' => 'form-control ', 'placeholder'=>'-ทั้งหมด-', 'id'=>'filter_condition_search']); !!}
                                    </div>
                                    <div class="col-md-6">
                                            {!! Form::text('filter_search', null, ['class' => 'form-control ', 'id' => 'filter_search', 'title'=>'ค้นหา:ชื่อกลุ่ม']); !!}
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="25%">ชื่อกลุ่ม</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#myTable').DataTable({
                ...
                ajax: {
                    url: '{!! url('/law/reward/reward/data_list') !!}',
                    data: function (d) {
