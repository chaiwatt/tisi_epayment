    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <select name="{{$name}}" id="{{$name}}" class="form-control">
                {{-- <option value="0" selected>จัดทำใบรับรอง</option>
                <option value="1" >ตรวจสอบความถูกต้อง</option> --}}
                <option value="2" >ออกใบรับรองและลงนาม</option>
                <option value="3" >ลงนามเรียบร้อย</option>
