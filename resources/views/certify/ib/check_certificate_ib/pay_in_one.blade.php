...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left"> Pay-In ครั้งที่ 1 ib</h3>
                    ...
                    <hr>
{!! Form::open(['url' => 'certify/check_certificate-ib/pay-in/'.$pay_in->id, 
...
@php 
 $SumCost = !empty($pay_in->CertiIBAuditorsTo->SumCostConFirm) ?  $pay_in->CertiIBAuditorsTo->SumCostConFirm  :  '0.00';
@endphp
  ...
  <div class="  {{ $errors->has('auditor') ? 'has-error' : ''}}">
      ...
      <div class="col-md-8 ">
          <p class="col-md-12 text-left ">   
               {{ $pay_in->CertiIBAuditorsTo->auditor ?? null }}
          </p>
      </div>
  </div>
</div>
<div class="form-group  {{ $errors->has('auditor') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4">
        <p class="col-md-12 text-left ">   
            {{  !empty($pay_in->CertiIBAuditorsTo->CertiIBAuditorsDateTitle) ?  $pay_in->CertiIBAuditorsTo->CertiIBAuditorsDateTitle : null}}
        </p>  
    </div>
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table class="table color-bordered-table primary-bordered-table">
                ...
                <tbody id="table_body">
                @if(count($pay_in->CertiIBAuditorsTo->CertiIBAuditorsCosts) > 0 )
                    @foreach($pay_in->CertiIBAuditorsTo->CertiIBAuditorsCosts as  $key => $item)
                    <tr>
...
<script src="{{ asset('plugins/components/icheck/icheck.init.js') }}"></script>
    ...
    <script src="{{ asset('js/app.js') }}"></script>
         ...
         $('#transaction_payin').click(function () { 
                ...
                var app_no          =   "{{ $pay_in->CertiIBCostTo->app_no ?? null }}";
