...
@endphp       
 {!! Form::open(['url' => 'certify/check_certificate-ib/create/pay-in2', 'class' => 'form-horizontal pay_in2_form', 'files' => true,'id'=>"pay_in2_form"]) !!}
                ...
                <div class="form-group {{ $errors->has('amount_file') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-5 text-left">
                          @if(!is_null($payin2)  && !is_null($payin2->FileAttachPayInTwo1To))
                            <a href="{{ url('certify/check/files_ib/'. $payin2->FileAttachPayInTwo1To->file) }}"> 
                ...
                <div class="col-md-4 "> 
                 ...
                 <div class="col-md-5 text-left">
                         @if(!is_null($payin2)  && !is_null($payin2->FileAttachPayInTwo2To))
                                <a href="{{ url('certify/check/files_ib/'. $payin2->FileAttachPayInTwo2To->file) }}"> 
               ...
               <div class="{{ $errors->has('attach') ? 'has-error' : ''}}">
                   ...
                   <div class="col-md-4 "> 
                    ...
                    <input type="text"  value="{{  !empty($payin2->report_date) ? HP::revertDate($payin2->report_date,true) : null}}"   name="report_date"
                        class="form-control mydatepicker   text-right" id="report_date" required>
...
<div class="modal-footer submit_remove"> 
    <input type="hidden" name="app_certi_ib_id" value="{{ $certi_ib->id ?? null}}">
...
@else 
{!! Form::open(['url' => 'certify/check_certificate-ib/update/pay-in2/'.@$payin2->id, 'class' => 'form-horizontal pay_in2_form', 'files' => true]) !!}
<div class="modal-body">
        @php 
            $amount  =  !empty($payin2->amount) ? $payin2->amount :  '0';
            $amount_fee  =  !empty($payin2->amount_fee) ?$payin2->amount_fee :  '0';
       ...
       @if(!is_null($payin2)  && !is_null($payin2->FileAttachPayInTwo1To))
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <p>  
                    <a href="{{ url('certify/check/files_ib/'. $payin2->FileAttachPayInTwo3To->file) }}"> 
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <p>  
                    <a href="{{ url('certify/check/files_ib/'. $payin2->FileAttachPayInTwo4To->file) }}"> 
