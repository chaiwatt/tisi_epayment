...
{{--
                      @can('edit-'.str_slug('estimatedcostib'))
                      ...
                      @can('add-'.str_slug('estimatedcostib'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/certify/estimated_cost-ib/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      {{-- @can('delete-'.str_slug('estimatedcostib'))
                    ...
                    {!! Form::model($filter, ['url' => '/certify/estimated_cost-ib', 'method' => 'get', 'id' => 'myFilter']) !!}
                    <div class="row">
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                     {{  $item->CertiIBCostTo->EsurvTrader->name ?? '-'  }}
                                 </td>
                                 ...
                                 <td class="text-center" >
                                   <a href="{{ url('certify/estimated_cost-ib/'.$item->id.'/edit') }}" class="btn btn-light btn-primary">
                               ...
                               <h3 style="color:red">
                                 <b>
                                   <i class="fa fa-exclamation-circle" style="color:rgb(255, 230, 0)"></i>
                                      ไม่มีการประมาณค่าใช้จ่ายคำขอใบรับรองหน่วยตรวจ (IB)
                                 </b>
                               </h3>
                             </td>
                           </tr>
    ...
    <script>
         $(document).ready(function () {
            $( "#filter_clear" ).click(function() {
                ...
                window.location.assign("{{url('/certify/estimated_cost-ib')}}");
            });
