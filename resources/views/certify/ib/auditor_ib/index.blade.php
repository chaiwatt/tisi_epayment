            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('auditorib'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/certify/auditor-ib/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      {{-- @can('delete-'.str_slug('auditorib'))
                    ...
                    {!! Form::model($filter, ['url' => '/certify/auditor-ib', 'method' => 'get', 'id' => 'myFilter']) !!}
                    <div class="row">
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                 ...
                                 <td  >
                                  @can('edit-'.str_slug('auditorib'))
                                     <a href="{{ url('certify/auditor-ib/'.$item->id.'/edit') }}" class="btn btn-light btn-primary">
                                       <i class="fa fa-pencil-square-o"></i>
                                    </a>
                                   @endcan
    
                                   @if (is_null($item->CertiIBPayInOneTo)   && $item->status_cancel != 1  || (auth()->user()->isAdmin() === true   && $item->status_cancel != 1))
                                      @can('delete-'.str_slug('auditorib'))
                                        ...
                                        @include ('certify/ib/auditor_ib.modaldelete',['id'=>$item->id])
                                      @endcan
                                  @endif
    ...
    <script>
        $(document).ready(function () {
          $( "#filter_clear" ).click(function() {
                ...
                window.location.assign("{{url('/certify/auditor-ib')}}");
            });
