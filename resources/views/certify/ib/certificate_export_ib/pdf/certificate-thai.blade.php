...
<table width="100%"   >
    ...
    @php
        ...
        $address1 =  $array_address[0].' '.$array_address[1].' '.$array_address[2].' '.$array_address[3].' '.$array_address[4].' '.$array_address[5].' '.$array_address[6].' '.$array_address[7];
    @endphp
        <tr>
    ...
    @else 
    @php
        $array_address =  explode(" ",$address_en);
        $address1 =  $array_address[0].' '.$array_address[1].' '.$array_address[2].' '.$array_address[3].' '.$array_address[4].
	' '.$array_address[5].' '.$array_address[6].' '.$array_address[7].' '.$array_address[8].' '.$array_address[9].' '.$array_address[10].' '.$array_address[11].' '.$array_address[12];
    @endphp
        <tr>
            <td align="center"   style="padding-top: -20px;"  class="font-7">
                {!! $address1 !!}  
            </td>
        </tr>
        <tr>
            <td align="center"  style="padding-top: -20px;"  class="font-7">
                {!!  str_replace($address1,"",$address_en)   !!}  
            </td>
        </tr>
    @endif
</table>
