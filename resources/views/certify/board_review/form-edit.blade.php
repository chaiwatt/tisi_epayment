    ...
    <div class="col-md-12">
        <div class="col-md-8">
            <div class="form-group {{ $errors->has('no') ? 'has-error' : ''}}">
                {!! Form::label('no', 'เลขคำขอ', ['class' => 'col-md-5 control-label label-filter']) !!}
                <div class="col-md-7">
                    {!! Form::text('taxid', $board->taxid ?? '', ['class' => 'form-control', 'placeholder'=>'', 'required' => true]); !!}
                </div>
            </div>
            <div class="form-group {{ $errors->has('judgement_date') ? 'has-error' : ''}}">
                {!! Form::label('judgement_date', 'วันที่ตรวจประเมิน'.':', ['class' => 'col-md-5 control-label']) !!}
                <div class="col-md-7">
                    <div class="input-group">
                        {!! Form::text('judgement_date', $board->judgement_date->format('d/m/Y'), ('' == 'required') ? ['class' => 'form-control mydatepicker',
            ...
            <div class="form-group {{ $errors->has('other_attach') ? 'has-error' : ''}}">
                {!! Form::label('other_attach', 'หนังสือแต่งตั้งคณะผู้ตรวจประเมิน'.':', ['class' => 'col-md-5 control-label']) !!}
                <div class="col-md-7">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="white-box">
                                        <div class="row">
                                            <div class="table-responsive">
                                                @php
                                                    $con = new App\Http\Controllers\Certify\BoardReviewController();
                                                    $auditors = $con->getAuditors($group->sa);
                                                    $pluck = $group->reviewers()->pluck('auditor_id');
                                                @endphp
                                                <table class="table table-bordered color-table primary-table" id="myTable" width="100%">
                                                    <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th><input type="checkbox" class="select-all" {{ count($auditors) == $pluck->count() ? 'checked' : '' }}></th>
