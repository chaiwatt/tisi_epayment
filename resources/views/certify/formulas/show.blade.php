...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ตั้งค่าสาขาตามมาตรฐาน {{ $formula->id }}</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table">
                            <tbody>
                              ...
                              <tr><th> Title </th><td> {{ $formula->title }} </td></tr><tr><th> State </th><td> {{ $formula->state }} </td></tr><tr><th> Created By </th><td> {{ $formula->created_by }} </td></tr><tr><th> Updated By </th><td> {{ $formula->updated_by }} </td></tr>
                              <tr>
                                <th> สถานะ </th>
