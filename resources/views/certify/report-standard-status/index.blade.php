...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">รายงานผลการดำเนินการจัดทำมาตรฐาน</h3>
                    ...
                    <div class="col-md-5 form-group ">
                      <div class=" {{ $errors->has('filter_status') ? 'has-error' : ''}}">
                          ...
                          <div class="col-md-9">
                              ...
                              ['1'=>'อยู่ระหว่างดำเนินการ', '2'=>'อยู่ระหว่างการประชุม', '3'=>'อยู่ระหว่างสรุปรายงานการประชุม', '4'=>'สรุปวาระการประชุมเรียบร้อย', '5'=>'อยู่ระหว่างจัดทำมาตรฐาน'], 
                            null, 
                            ['class' => 'form-control', 
                            'id'=>'filter_status',
                ...
                <div class="row">
                        <div class="col-md-12">
                            ...
                            <tr>
                                ...
                                <th width="15%" class="text-center">งบประมาณที่ใช้</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/certify/report/standard-status/data_list') !!}',
                    data: function (d) {
