...
<table width="100%"   >
<tr>
    <td align="center" class="font-18" style="padding-top: -15px;"  >
...
@if (count($branch_th) > 0)
<table width="100%"  style="padding-top: -8px;">
@foreach ($branch_th as $item)
     <tr>
        <td align="center" class="line-height25  {{ $item->font }}"  >
            {!! $item->title !!}  
        </td>
...
<table width="100%"   style="padding-top: -10px;" >
<tr>
    <td  align="center"  colspan="3"   class="font-18"   style="padding-top: -20px;"      >
