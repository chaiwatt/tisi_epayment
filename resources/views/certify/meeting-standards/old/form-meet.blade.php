...
<div class="form-group {{ $errors->has('setstandard_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::select('setstandard_id[]'
        ,App\Models\Certify\SetStandards::pluck('projectid', 'id'), 
        !empty($meetingstandard_project)?$meetingstandard_project:null,
         ['class' => 'select2-multiple',
          'multiple'=>'multiple',
           'data-placeholder' => '-เลือก Projectที่เกี่ยวข้อง-', 
           'required' => true]); !!}
