                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group {{ $errors->has('modal_app_no') ? 'has-error' : ''}}">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('modal_app_no', !empty($certi_lab->app_no)?  $certi_lab->app_no :null, ['class' => 'form-control','id'=>'modal_app_no', 'readonly' => true]) !!}
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-md-6">
                                     <div class="checkbox checkbox-success ">
                                            <input id="state1" type="checkbox"  checked  disabled>
                                            <label for="state1" > เปิดใช้งานขอบข่าย </label>
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        success: function (msg) {
                            if (msg != "") {
                                ...
                                var tr_ = '';
                                    ...
                                    tr_ += '<td class="text-center"><div class="checkbox"> <input class="js-switch" type="checkbox" value="1"  name="state"   checked data-color="#13dafe"  data-certilab_file_id="'+msg.id+'"> </div></td>';
