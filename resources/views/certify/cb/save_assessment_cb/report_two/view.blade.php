...
<div id="auditorModal" class="modal">
    <div class="modal-dialog">
        ...
        <form id="labMessageForm" method="POST" action="{{ route('save.create_lab_message_record') }}">
            ...
            <div class="section">
                <div class="label">8. ผู้แทนหน่วยตรวจ : <button id="addAuditorRepresentative" class="toolbar" type="button" onclick=""><i class="fas fa-plus"></i></button></div>
                <div class="content">
                    <div class="info">
                        <div id="auditorRepresentativeWrapper">
...
var cbReportInfo = @json($cbReportInfo);
var assessment = @json($assessment);
var cbReportInfoSigners = @json($cbReportInfoSigners);
var certi_cb = @json($certi_cb);

console.log(cbReportInfo);
// console.log('cbReportInfo',cbReportInfo.item_401_chk);
let data;
const signer = [
    {
        "id": "1",
...
$(document).ready(function() 
{
    ...
    cbReportInfoSigners.forEach((transaction, index) => {
    ...
    let data = [
    {
        "eval_riteria_text": cbReportInfo.eval_riteria_text,
        "background_history": cbReportInfo.background_history,
        "insp_proc": cbReportInfo.insp_proc,
        "evaluation_key_point": cbReportInfo.evaluation_key_point,
        "observation": cbReportInfo.observation,
        "evaluation_result": cbReportInfo.evaluation_result,
        "auditor_suggestion": cbReportInfo.auditor_suggestion,
        "evaluation_detail": {
            "item_401": {
                "chk": cbReportInfo.item_401_chk === "1",     
                "eval_select": cbReportInfo.item_401_eval_select,  
                "comment": cbReportInfo.item_401_comment      
            },
            "item_402": {
                "chk": cbReportInfo.item_402_chk === "1",      
                "eval_select": cbReportInfo.item_402_eval_select,
                "comment": cbReportInfo.item_402_comment         
            },
            "item_501": {
                "chk": cbReportInfo.item_501_chk === "1",      
                "eval_select": cbReportInfo.item_501_eval_select,
                "comment": cbReportInfo.item_501_comment         
            },
            "item_601": {
                "chk": cbReportInfo.item_601_chk === "1",      
                "eval_select": cbReportInfo.item_601_eval_select,
                "comment": cbReportInfo.item_601_comment         
            },
            "item_602": {
                "chk": cbReportInfo.item_602_chk === "1",      
                "eval_select": cbReportInfo.item_602_eval_select,
                "comment": cbReportInfo.item_602_comment         
            },
            "item_603": {
                "chk": cbReportInfo.item_603_chk === "1",      
                "eval_select": cbReportInfo.item_603_eval_select,
                "comment": cbReportInfo.item_603_comment         
            },
            "item_701": {
                "chk": cbReportInfo.item_701_chk === "1",      
                "eval_select": cbReportInfo.item_701_eval_select,
                "comment": cbReportInfo.item_701_comment         
            },
            "item_702": {
                "chk": cbReportInfo.item_702_chk === "1",      
                "eval_select": cbReportInfo.item_702_eval_select,
                "comment": cbReportInfo.item_702_comment         
            },
            "item_703": {
                "chk": cbReportInfo.item_703_chk === "1",      
                "eval_select": cbReportInfo.item_703_eval_select,
                "comment": cbReportInfo.item_703_comment         
            },
            "item_704": {
                "chk": cbReportInfo.item_704_chk === "1",      
                "eval_select": cbReportInfo.item_704_eval_select,
                "comment": cbReportInfo.item_704_comment         
            },
            "item_705": {
                "chk": cbReportInfo.item_705_chk === "1",      
                "eval_select": cbReportInfo.item_705_eval_select,
                "comment": cbReportInfo.item_705_comment         
            },
            "item_706": {
                "chk": cbReportInfo.item_706_chk === "1",      
                "eval_select": cbReportInfo.item_706_eval_select,
                "comment": cbReportInfo.item_706_comment         
            },
            "item_801": {
                "chk": cbReportInfo.item_801_chk === "1",      
                "eval_select": cbReportInfo.item_801_eval_select,
                "comment": cbReportInfo.item_801_comment         
            },
            "item_802": {
                "chk": cbReportInfo.item_802_chk === "1",      
                "eval_select": cbReportInfo.item_802_eval_select,
                "comment": cbReportInfo.item_802_comment         
            },
            "item_803": {
                "chk": cbReportInfo.item_803_chk === "1",      
                "eval_select": cbReportInfo.item_803_eval_select,
                "comment": cbReportInfo.item_803_comment         
            },
            "item_804": {
                "chk": cbReportInfo.item_804_chk === "1",      
                "eval_select": cbReportInfo.item_804_eval_select,
                "comment": cbReportInfo.item_804_comment         
            },
            "item_805": {
                "chk": cbReportInfo.item_805_chk === "1",      
                "eval_select": cbReportInfo.item_805_eval_select,
                "comment": cbReportInfo.item_805_comment         
            },
            "item_806": {
                "chk": cbReportInfo.item_806_chk === "1",      
                "eval_select": cbReportInfo.item_806_eval_select,
                "comment": cbReportInfo.item_806_comment         
            },
            "item_807": {
                "chk": cbReportInfo.item_807_chk === "1",      
                "eval_select": cbReportInfo.item_807_eval_select,
                "comment": cbReportInfo.item_807_comment         
            },
            "item_808": {
                "chk": cbReportInfo.item_808_chk === "1",      
                "eval_select": cbReportInfo.item_808_eval_select,
                "comment": cbReportInfo.item_808_comment         
            },
            "insp_cert": {
                "chk": cbReportInfo.insp_cert_chk === "1",      
                "eval_select": cbReportInfo.insp_cert_eval_select,
                "comment": cbReportInfo.insp_cert_comment         
            },
            "reg_std_mark": {
                "chk": cbReportInfo.reg_std_mark_chk === "1",      
                "eval_select": cbReportInfo.reg_std_mark_eval_select,
                "comment": cbReportInfo.reg_std_mark_comment         
            }
        }
    }
];
...
function submit_form(status) 
{
    ...
    $.ajax({
        type: "POST",
        url: "{{url('/certify/save_assessment-cb/cb-report-two-store')}}",
        datatype: "script",
        data: formData,
        contentType: false,
        cache: false,
