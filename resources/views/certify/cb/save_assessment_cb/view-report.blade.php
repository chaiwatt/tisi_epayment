...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <div class="left-text">คำขอที่ {{$certi_cb->app_no}}</div>
        ...
        <div class="checkbox-section">
            ...
            <div style="display: flex; gap: 10px; align-items: center; margin-bottom: 5px;">
                <span>
                    <label>
                        <input type="checkbox" 
                            @if ($certi_cb->purpose_type == null || !in_array($certi_cb->purpose_type, [1, 2, 3]))
                                checked
                            @endif
                            disabled
                        >
       ...
       <div style="margin-top: 15px;margin-left:10px; line-height:36px;font-weight:600">
        ...
        <div style="margin-top: 10px;margin-left:20px; line-height:36px">
            ...
            <div>
                ...
                <span>{{HP::formatDateThaiFullPoint($certi_cb->start_date)}}</span>
            </div>
            <div>
                <span>สาขาและขอบข่าย :</span>
                <span>ตามเอกสารประกอบคำขอของ ห้องปฏิบัติการ ลงวันที่ {{HP::formatDateThaiFullPoint($certi_cb->get_date)}} และ/หรือหนังสือขอแก้ไขขอบข่ายของ ห้องปฏิบัติการ ลงวันที่ {{HP::formatDateThaiFullPoint($assessment->date_car)}} (ถ้ามี)/ ขอบข่าย ดังแนบ</span>
            </div>
        </div>
        ...
        <div style="margin-left:20px; line-height:36px">
            ...
            <div style="margin-top:10px;">
                    ...
                    <span >{{HP::formatDateThaiFullPoint($assessment->assessment_date)}}</span>  
            </div>
            <div style="margin-top:10px;">
    ...
    {{-- <div  class="wrapper" style="line-height: 36px"> --}}
        ...
        <div style="margin-left: 20px">
            ...
            <div style="margin-left:30px; line-height:36px">
                ...
                <div style="margin-left: 30px">
                    <span>ห้องปฏิบัติการต้องส่งแนวทาง และแผนการดำเนินการปฏิบัติการแก้ไขข้อบกพร่อง ให้สำนักงานพิจารณาภายใน 30 วันนับแต่วันที่ออกรายงานข้อบกพร่อง และต้องส่งหลักฐานการแก้ไขข้อบกพร่องอย่างมีประสิทธิผลและเป็นที่ยอมรับของคณะผู้ตรวจประเมิน ภายในวันที่ <input type="text" class="input-no-border" placeholder="" style="width: 180px;text-align:center" name="3_0_deficiency_resolution_date" id="3_0_deficiency_resolution_date"> (ภายใน 90 วันนับแต่วันที่ออกรายงานข้อบกพร่อง) 
                        ...
                        กรณีห้องปฏิบัติการสามารถดำเนินการแก้ไขข้อบกพร่องทั้งหมดได้แล้วเสร็จสอดคล้องตาม มาตรฐานเลขที่ มอก. 17025-2561 ภายในระยะเวลาที่กำหนด คณะผู้ตรวจประเมินจะนำเสนอคณะอนุกรรมการพิจารณารับรองห้องปฏิบัติการ{{$certi_cb->lab_name}} เพื่อพิจารณาให้การรับรองต่อไป
                    </span>
                </div>
            </div>
            <div style="margin-left:30px; line-height:36px">
                <table>
                    <tr>
                        ...
                        <td>
                            <span >
                                ห้องปฏิบัติการมีระบบการบริหารงานและการดำเนินงานด้านวิชาการเป็นไปตามมาตรฐานเลขที่ มอก. 17025-2561 ในขอบข่ายที่ขอรับการรับรอง คณะผู้ตรวจประเมินเห็นควรนำเสนอคณะอนุกรรมการพิจารณารับรองห้องปฏิบัติการ{{$certi_cb->lab_name}}. เพื่อพิจารณาให้การรับรองต่อไป 
                            </span>
                        </td>
                    </tr>
                </table>
            ...
            <div style="text-align: center;margin-bottom:20px;margin-top:20px" id="button_wrapper">
                ...
                @if ($assessment->report_status == 2 || ($assessment->report_status == 1 && $assessment->degree == 4))
