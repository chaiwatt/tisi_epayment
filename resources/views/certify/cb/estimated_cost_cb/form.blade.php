        ...
        <div class="form-group">
            ...
            @if(isset($app_no))
               ...
               'placeholder'=>'-เลือกคำขอ-'])
                !!}
            @else 
            <input type="text" class="form-control" value="{{ $cost->CertiCBCostTo->app_no ?? null }}"   disabled >
            @endif
            </div>
            </div>
            <div class="col-md-7">
            ...
            <div class="col-md-7">
                <input type="text" class="form-control" value="{{ $cost->CertiCBCostTo->name ?? null }}" name="department" disabled id="department">
            </div>
            </div>
        </div>
    </div>
                    ...
                    @if(count($cost->FileAttachCost1) > 0)  
                        ...
                        <div class="row form-group deleteFlie{{$item->id}}">
                            <div class="col-md-4  text-light">
                             ...
                             {{-- <button class="btn btn-danger btn-sm deleteFlie" type="button" onclick="deleteFlie({{ $item->id }})">
...
@if(count($cost->CertiCbHistorys) > 0 && !is_null($cost->date) ) 
@include ('certify/cb/estimated_cost_cb.log')
@endif
...
<div class="form-group">
    ...
    <div class="col-md-18 text-center">
        ...
        <br>
        @if($cost->draft == 0)
           <button   type="submit" class="btn btn-success" name="draft" value="0"   ><i class="fa fa-file-o"></i> ฉบับร่าง</button>
        @endif
        ...
        <a href="{{ url('certify/estimated_cost-cb') }}" class="btn btn-default"><i class="fa fa-rotate-left"></i> ยกเลิก</a>
    </div>
</div>
@else
<div class="clearfix"></div>
   <a  href="{{ url("certify/estimated_cost-cb") }}"  class="btn btn-default btn-lg btn-block">
    ...
    $(document).ready(function () {
        ...
        $('.check-readonly').parent().css('margin-top', '8px');
            ...
            $('#app_no').change(function(){
                    ...
                    if($(this).val()!=""){
                        $.ajax({
                            url: "{!! url('certify/estimated_cost-cb/app_no') !!}" + "/" + $(this).val()
