...
<div class="row">
  ...
  <div class="col-md-7 text-left">
        {{-- @if($history->file !='' && HP::checkFileStorage($attach_path.$history->file)) --}}
            <a href="{{url('certify/check/file_cb_client/'.$item->file.'/'.( !empty($history->file_client_name) ? $history->file_client_name : basename($history->file) ))}}" target="_blank">
