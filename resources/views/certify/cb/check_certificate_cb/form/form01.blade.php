...
<div class="white-box" style="border: 2px solid #e5ebec;">
    <legend><h4>คำขอรับใบรับรองหน่วยรับรอง</h4></legend>

    <div class="row">

        @if(isset($certi_cb) && $certi_cb->status >= 9)
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    <p>
                        {{ !empty($certi_cb->save_date) ?   HP::formatDateThaiFull($certi_cb->save_date) : '-' }} 
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            {!! Form::text('app_name', $certi_cb->name ?? null, ['class' => 'form-control','disabled'=>true]) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="id_tax">เลขประจำตัวผู้เสียภาษีอากร: <span class="">(Tax ID)</span>  </label>
                            {!! Form::text('certi_information[tax_indentification_number]' ,!empty($certi_cb->tax_id) ? $certi_cb->tax_id : null, ['class' => 'form-control id-inputmask','disabled'=>true]) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('certi_information[trader_address]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address]',!empty($certi_cb->hq_address)? $certi_cb->hq_address : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_num"]) !!}
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_address_soi]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address_soi]',!empty($certi_cb->hq_soi)? $certi_cb->hq_soi : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_soi"]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_address_road]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address_road]',!empty($certi_cb->hq_road)? $certi_cb->hq_road : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_street"]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_address_moo]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address_moo]',!empty($certi_cb->hq_moo)? $certi_cb->hq_moo : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_moo"]) !!}
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_address_tumbol]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address_tumbol]',!empty($certi_cb->HqSubdistrictName)? $certi_cb->HqSubdistrictName : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_tumbon"]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_address_amphur]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address_amphur]',!empty($certi_cb->HqDistrictName)? $certi_cb->HqDistrictName : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_area"]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_provinceID]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_provinceID]',!empty($certi_cb->HqProvinceName)? $certi_cb->HqProvinceName : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_province"]) !!}
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_address_poscode]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_address_poscode]',!empty($certi_cb->hq_zipcode)? $certi_cb->hq_zipcode : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_post"]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_phone]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_phone]',!empty($certi_cb->hq_telephone)? $certi_cb->hq_telephone : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_tel"]) !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('certi_information[trader_fax]') ? 'has-error' : ''}}">
                            ...
                            {!! Form::text('certi_information[trader_fax]',!empty($certi_cb->hq_fax)? $certi_cb->hq_fax : null, ['class' => 'form-control','disabled'=>true,'id'=>"head_fax"]) !!}
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div  class="col-md-4">
                            {!! Form::text('certi_information[trader_id_register]',!empty($certi_cb->hq_date_registered)? HP::revertDate($certi_cb->hq_date_registered,true)  : null, ['class' => 'form-control ','disabled'=>true]) !!}
