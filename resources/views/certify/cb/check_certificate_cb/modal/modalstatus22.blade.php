  ...
  <!-- Modal -->
   <div class="modal fade bd-example-modal-lg" id="exampleModalExport" tabindex="-1" role="dialog" aria-labelledby="exampleModalExportLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        {!! Form::open(['url' => 'certify/check_certificate-cb/update/update_attach/'.$certi_cb->id, 'class' => 'form-horizontal', 'files' => true,'id'=>'form_update_attach']) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-left">
                                            ...
                                            <a href="{{url('certify/check/file_cb_client/'.$itme->attach.'/'.( !empty($itme->attach_client_name) ? $itme->attach_client_name :   basename($itme->attach) ))}}" 
                                            ...
                                            <a href="{{url('certify/check/file_cb_client/'.$itme->attach_pdf.'/'.( !empty($itme->attach_pdf_client_name) ? $itme->attach_pdf_client_name :   basename($itme->attach_pdf) ))}}" 
