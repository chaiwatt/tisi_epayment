...
<div class="modal fade" id="PayIn1Modal" tabindex="-1" role="dialog" aria-labelledby="PayIn1Modal" aria-hidden="true">
 ...
 <div class="modal-content">
     ...
     {{-- readonly --}}
 {!! Form::open(['url' => 'certify/check_certificate-cb/pay-in/'.$id, 'class' => 'form-horizontal', 'files' => true,'id'=>"pay_in1_form"]) !!}
 ...
 <div class="modal-body">
  ...
  @if($item->status != 1)
    @php 
        $SumCost = !empty($item->CertiCBAuditorsTo->SumCostConFirm) ? $item->CertiCBAuditorsTo->SumCostConFirm :  '0.00';
    @endphp
 <div class="row">
    <div class="col-md-12">
        <div class="white-box" style="border: 2px solid #e5ebec;">
    <legend><h3>{{ $item->CertiCBAuditorsTo->auditor ?? null }}</h3></legend>   
...
<div class="col-sm-6">
    <p>
        <a href="{{url('certify/check/files_cb/'.$item->FileAttachPayInOne2To->file)}}" target="_blank">
...
<!-- START  Show  -->
@if($certi_cb->CertiCBPayInOneStatus == "StatusPayInOneNeat")
@if(count($payin1) > 0)
@foreach($payin1 as $key => $item)
 <div class="row">
    <div class="col-md-12">
...
<div class="modal-footer">
    @if($certi_cb->CertiCBPayInOneStatus != "StatePayInOne" && $certi_cb->CertiCBPayInOneStatus != "StatusPayInOneNeat")   
