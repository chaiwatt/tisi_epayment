...
<body>
   <div id="style">
            ...
            <thead>
                    <tr>
                        ...
                        <th align="center" width="20%">  
                             มอก. {{  !empty($assessment->CertiCBCostTo->FormulaTo->title) ?   str_replace("มอก.","",$assessment->CertiCBCostTo->FormulaTo->title) :''  }}
                        </th>
        ...
        <p class="indent50">   
           <b>รายงานการตรวจประเมิน : </b> <a href="{{ url('certify/check/files_cb') . '/' . $assessment->FileAttachAssessment1To->file }}"  target="_blank" 
                                            title="{{  basename($assessment->FileAttachAssessment1To->file) }}">
                                            {{ basename($assessment->FileAttachAssessment1To->file)  }}
                                         </a>
        </p>
        @endif
         <p>
