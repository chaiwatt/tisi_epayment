...
<body>
   <div id="style">
        ...
        <p>
            <b>เรื่อง  แจ้งเตือนยืนยันใบรับรองหน่วยรับรอง </b>
        </p>
        <p class="indent50"> 
              ตามที่บริษัท {{$name}} ได้ทำการยืนยันคำขอใบรับรองหน่วยรับรอง  หมายคำขอที่  {{ $app_no ?? '-' }}    
              เมื่อวันที่ {{ HP::formatDateThaiFull(date('Y-m-d')) }} 
              จึงขอแจ้งครบ {{$number??'-'}} วันแล้ว หลังจากทำการยืนยันคำขอใบรับรองหน่วยรับรอง
        </p> 
        <p>
           โปรดคลิก
