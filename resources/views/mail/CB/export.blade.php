...
<body>
   <div id="style">
        ...
        <p>
            <b>เรื่อง   ใบรับรองหน่วยรับรอง </b>
        </p>
 
        <p class="indent50"> 
            ตามที่  {{  !empty($certi_cb->name) ? $certi_cb->name   :  '' }}  ได้ยื่นคำขอรับใบรับรองหน่วยรับรอง
          เมื่อวันที่  {{  !empty($certi_cb->start_date) ?  HP::formatDateThaiFull($certi_cb->start_date) :  ''  }} 
          สำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรม ได้ดำเนินการออกใบรับรองระบบงานหน่วยรับรอง แล้ว
