...
<div id="style">
    ...
    <p style="text-indent: 50px;">ตามที่    {{  !empty($certi_ib->name) ?  $certi_ib->name  :  ''  }}  ได้แนบหลักฐานการชำระเงินค่าธรรมเนียมคำขอ และค่าธรรมเนียมใบรับรอง คำขอรับใบรับรองหน่วยรับรอง
     หมายเลขคำขอ  {{  !empty($certi_ib->app_no) ?   $certi_ib->app_no  :  ''  }}   สำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรม
     @if ($PayIn->status == 1)
