...
<body>
   ...
   <p class="indent50"> 
      ...
      คำขอเลขที่  {{  !empty($certi_ib->app_no) ?   $certi_ib->app_no  :  ''  }} 
       ลงรับวันที่  {{  !empty($certi_ib->save_date) ?  HP::formatDateThaiFull($certi_ib->save_date) :  ''  }}  นั้น
   </p>
   <p class="indent50"> 
       สำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรมขอแจ้งสรุปสาขา/ขอบข่ายที่ขอรับการรับรองหน่วยตรวจ และประมาณการค่าใช้จ่ายในการตรวจประเมิน โดยมีรายละเอียดดังนี้
   </p>
   ...
   <p class="indent50"> 
        และหากท่านมีความประสงค์จะเปลี่ยนแปลงสาขา/ขอบข่ายที่ขอรับการรับรองหน่วยตรวจ
        โปรดแจ้งสำนักงานทราบพร้อมระบุเหตุผลภายใน 15 วัน หากพ้นกำหนดเวลาดังกล่าว 
        สำนักงานจะถือว่าท่านยืนยันและยอมรับในสาขา/ขอบข่ายที่ขอรับการรับรองหน่วยตรวจ ตามข้างต้น
    </p>
    <p>
