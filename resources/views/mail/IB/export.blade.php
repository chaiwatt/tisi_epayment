...
<body>
   <div id="style">
        ...
        <p>
            <b>เรื่อง   ใบรับรองหน่วยตรวจ </b>
        </p>

        <p class="indent50"> 
            ตามที่  {{  !empty($certi_ib->name) ?  $certi_ib->name  :  '' }}  ได้ยื่นคำขอรับใบรับรองหน่วยตรวจ
        เมื่อวันที่  {{  !empty($certi_ib->start_date) ?  HP::formatDateThaiFull($certi_ib->start_date) :  ''  }} 
        สำนักงานมาตรฐานผลิตภัณฑ์อุตสาหกรรม ได้ดำเนินการออกใบรับรองระบบงานหน่วยตรวจ แล้ว
