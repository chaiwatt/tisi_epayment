...
<body>
   <div id="style">
        <p>
            <b>เรียน  เจ้าหน้าที่</b>
        </p>
        <p>
            <b>เรื่อง  แจ้งเตือนยืนยันใบรับรองห้องปฏิบัติการ </b>
        </p>
        <p class="indent50"> 
              ตามที่บริษัท {{$name}} ได้ทำการยืนยันคำขอใบรับรองห้องปฏิบัติการ  หมายคำขอที่  {{ $app_no ?? '-' }}    
              เมื่อวันที่ {{ HP::formatDateThaiFull(date('Y-m-d')) }} 
              จึงขอแจ้งครบ {{$number??'-'}} วันแล้ว หลังจากทำการยืนยันคำขอใบรับรองห้องปฏิบัติการ
        </p> 
        <p>
           โปรดคลิก
