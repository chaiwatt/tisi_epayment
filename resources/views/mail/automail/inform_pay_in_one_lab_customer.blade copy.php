...
<body>
   <div id="style">
    <p> 
        <b> 
            เรียน  {{  !empty($certi_lab->check->FullRegName ) ?   $certi_lab->check->FullRegName   :  ''  }}   
         </b> 
     </p>
     <p> 
         <b> เรื่อง  แจ้งตรวจสอบการชำระค่าบริการในการตรวจประเมิน
         </b> 
      </p>
      <p class="indent50"> 
         ตามที่   {{  !empty($certi_lab->BelongsInformation->name) ?  $certi_lab->BelongsInformation->name   :  ''  }} 
         ได้แนบหลักฐานการชำระเงินค่าบริการในการตรวจประเมินคำขอรับบริการห้องปฏิบัติการ หมายเลขคำขอ   {{  !empty($certi_lab->app_no) ?   $certi_lab->app_no  :  ''  }} 
