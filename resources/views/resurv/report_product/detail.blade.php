                                        ...
                                        @foreach($data_map_table as $list)
                                            <tr>
                                                ...
                                                <td style="font-size: 14px; vertical-align: text-top;">
                                                    <input class="form-control input-sm txt-center" disabled value="{{HP::map_lap_number3($list->detail_product_maplap,$list->example_id)}}">
                                                </td>
                                                <td style="font-size: 14px; vertical-align: text-top;">
                                                    <input class="form-control input-sm txt-center" name="number_labget[]" disabled  value="{{$list->number_labget}}">
                                                </td>
                                                <td style="font-size: 14px; vertical-align: text-top;">
                                                    <input class="form-control input-sm txt-center" disabled value="{{HP::map_lap_num_ex3($list->detail_product_maplap,$list->example_id)}}">
                                                </td>
                                                <td style="font-size: 14px; vertical-align: text-top;">
                                                    @php
