        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title pull-left">นำเข้าปฏิทิน</h3>

                    <div class="pull-right">

                        @can('edit-'.str_slug('configs-import-holiday'))
                        ...
                        @can('add-'.str_slug('configs-import-holiday'))
                            <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/config/import-holiday/create') }}">
                                <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                            </a>
                        @endcan

                        @can('delete-'.str_slug('configs-import-holiday'))
                    ...
                    <p class="text-muted m-b-30 font-13"><em>นำเข้าปฏิทิน</em></p>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/config/import-holiday/data_list') !!}',
                    data: function (d) {
