...
<div class="form-group required {{ $errors->has('title') ? 'has-error' : ''}}">
    {!! Form::label('title', 'ชื่อกลุ่มงานเอกสาร (TH)', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('title_en') ? 'has-error' : ''}}">
    {!! Form::label('title_en', 'ชื่อกลุ่มงานเอกสาร (EN)', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group">
    <div class="col-md-offset-4 col-md-4">
        ...
        @can('view-'.str_slug('configs-evidence-systems'))
            <a class="btn btn-default show_tag_a" href="{{url('/config/evidence/system')}}">
