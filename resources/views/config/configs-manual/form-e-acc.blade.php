...
@php
    $tisi_e_acc = App\Models\Config\ConfigsManual::where('site', 'tisi-e-acc' )->get()
@endphp

<div data-repeater-list="repeater-e-acc">

    @if( count($tisi_e_acc) > 0 )

        @foreach ( $tisi_e_acc as $item )
