...
@php
    $tisi_center = App\Models\Config\ConfigsManual::where('site', 'tisi-center' )->get()
@endphp

<div data-repeater-list="repeater-center">


    @if( count($tisi_center) > 0 )

        @foreach ( $tisi_center as $item )
