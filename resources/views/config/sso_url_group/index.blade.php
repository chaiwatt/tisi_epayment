...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">ตั้งค่ากลุ่ม URL SSO</h3>

                    <div class="pull-right">

                        @can('add-'.str_slug('SsoUrl'))
                            <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/config/sso-url-group/create') }}">
                    ...
                    {!! Form::model($filter, ['url' => '/config/sso-url-group', 'method' => 'get', 'id' => 'myFilter']) !!}
                    ...
                    <div class="table-responsive">
                        ...
                        {!! Form::open(['url' => '/config/sso-url-group/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('view-'.str_slug('SsoUrl'))
                                            <a href="{{ url('/config/sso-url-group/' . $item->id) }}"
                                        ...
                                        @can('edit-'.str_slug('SsoUrl'))
                                            <a href="{{ url('/config/sso-url-group/' . $item->id . '/edit') }}"
                                        ...
                                        @can('delete-'.str_slug('SsoUrl'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/config/sso-url-group', $item->id],
            ...
            @if(Request::get('sort')=='ordering')
                ...
                $( "#sortable" ).sortable({
                    ...
                    stop:function(event, ui) {
                        ...
                        $.post('{{ url('config/sso-url-group/update_order') }}',
                               {
                                   _token: "{{ csrf_token() }}",
                                   ids: ids,
                                   orders: orders,
