    ...
    <div class="lab-header">
        ...
        <div class="info">
            ...
            <div class="inline-block w-78">
                <div class="inline-block w-55 float-left">
                    ออกให้ตั้งแต่วันที่ 30 สิงหาคม พ.ศ. 2566<br> <span style="padding-left:20px">(Valid from) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(30nd August B.E. 2566 (2023))</span>
                </div>
        ...
        <div class="info" style="margin-top: 7px">
            ...
            <div class="inline-block w-78 float-left">
                @if ($branchNo !== null){{$branchNo}}.@endif เลขที่ 1285/5 ถนนประชาชื่น แขวงวงศสวาง เขตบางซื่อ กรุงเทพมหานคร<br> <span> (1285/5 Prachachuen Road, Wong Sawang, Bangsue, Bangkok)</span>
            </div>
        </div>
    </div>
