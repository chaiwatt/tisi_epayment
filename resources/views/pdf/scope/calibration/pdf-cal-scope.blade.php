            ...
            <tr>
                ...
                <td style="vertical-align: top;width:25%">
                    <table class="table-one" cellspacing="0" width="100%" >
                        <tr>
                            <td ><span style="margin-top:5px">{{ $item->instrument }} </span><span style="font-size:1px;visibility: hidden">*{{$key}}*</span></td>
                        </tr>
                        <tr>
                            <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if (preg_match('/\.(png|jpg|jpeg|gif)$/i', $range->range))
                                                                            <td  style="padding-left: 0px">
                                                                                <img src="{{ public_path('assets/images/scopes/'. $range->range) }}" alt="Image" style="max-width:160px;visibility: hidden" />                                                                                  
                                                                            </td>
                                                                        @else
               ...
               <td style="vertical-align: top;width:25%">
                    <table class="table-one" cellspacing="0" width="100%" >
                        <tr>
                            <td ><span style="visibility: hidden;margin-top:5px">{{ $item->instrument }}</span><span style="font-size:1px;visibility: hidden">*{{$key}}*</span></td>
                        </tr>
                        <tr>
                            <td>
                                <table class="table-two" cellspacing="0"  width="100%">
                                                            ...
                                                            <table class="table-four" cellspacing="0" width="100%" style="text-align: center;padding-right:3px">
                                                                @foreach ($measurement->ranges as $i => $range)
                                                                    ...
                                                                    <tr>
                                                                        @if (preg_match('/\.(png|jpg|jpeg|gif)$/i', $range->range))
                                                                            <td  style="padding-left: 0px">
                                                                                <img src="{{ public_path('assets/images/scopes/'. $range->range) }}" alt="Image" style="max-width:160px" />                                                                                  
                                                                            </td>
                                                                        @else
