...
<div>
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label class="col-md-3 control-label">กิจกรรม:<span class="text-danger">*</span></label>
                <div class="col-md-9">
    ...
    <div class="row m-t-15">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="year" class="col-md-5 control-label">ปีงบประมาณ:<span class="text-danger">*</span></label>
                <div class="col-md-7">
      ...
      <div class="col-md-5">
            <div class="form-group">
                <label for="startdate" class="col-md-1 control-label">วัน:<span class="text-danger">*</span></label>
                <div class="col-md-5">
                ...
                <label for="enddate" class="col-md-1 control-label">ถึง:<span class="text-danger">*</span></label>
                <div class="col-md-5">
        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <vue-autonumeric :options="intOptions" v-model="values.no1.v1" name="numpeople_g" class="form-control text-right required" placeholder="จำนวน (คน)" required></vue-autonumeric>
                    </td>
                    <td>
                        <vue-autonumeric :options="floatOptions" v-model="values.no1.v2" name="allowances_referee_g" class="form-control text-right required" placeholder="เบี้ยประชุม(กรรมการ)" required></vue-autonumeric>
                    </td>
                    <td>
                        <vue-autonumeric :options="floatOptions" v-model="values.no1.v3" name="allowances_persident_g" class="form-control text-right required" placeholder="เบี้ยประชุม(ประธาน)" required></vue-autonumeric>
                    </td>
                    <td>&nbsp;</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <vue-autonumeric :options="intOptions" v-model="values.no3.v1" name="numpeople_attendees" class="form-control text-right" placeholder="จำนวน (คน)" required></vue-autonumeric>
                    </td>
                    <td>
    ...
    export default {
        ...
        computed: {
            ...
            totalNoAll: function() {
                ...
                const number = this.totalNo1 + this.totalNo3;
                return Math.round(number * 100) / 100;
            },
            totalPeople: function () {
                return this.values.no3.v1 - (this.values.no1.v1);
            }
        },
        methods: {
            ...
            onSubmit: async function () {
                ...
                console.log(this.propUrl);
                    if (isEmpty(this.statusId) || isEmpty(this.year)
                        || isEmpty(this.startDate) || isEmpty(this.endDate)) {

                            //  $(this.$refs.startdate).next('p').text("w,jsokfoskf");
                        const message = 'กรุณาใส่ข้อมูลให้ครบทุกช่อง';
                        $.toast({
                            heading: 'Wrong!',
                            position: 'top-center',
                            text: message,
